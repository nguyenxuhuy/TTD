$PBExportHeader$c_so_return.sru
forward
global type c_so_return from b_doc
end type
end forward
...
global c_so_return c_so_return
...
public subroutine f_set_dwo_window ();istr_dwo[1].s_dwo_default =  'd_document_so_return_grid'
istr_dwo[1].s_dwo_form = 'd_document_so_return_form'
istr_dwo[1].s_dwo_grid = 'd_document_so_return_grid'
...
istr_dwo[1].s_description = 'Đơn trả hàng (SO return)'
...
istr_dwo_related[1].s_main_obj_column_copy[1] = 'object_id;object_code;object_name;ship_to_addtext;bill_to_object;object_name_1;object_code_1;bill_to_addtext;'
istr_dwo_related[1].s_main_obj_column_copy[1] += 'due_date;payment_term_code;payment_term_name;payment_method_code;payment_method_name;'
istr_dwo_related[1].s_main_obj_column_copy[1] += 'uom_code;currency_id;exchange_rate;include_tax_yn;note;payment_term;payment_method;delivery_mode_code;delivery_mode_name;delivery_mode;contact_name;contact_id'
istr_dwo_related[1].s_related_obj_dwo_copy[1] = 'd_order_so_form' // datawindow copy đến
istr_dwo_related[1].s_related_obj_column_copy[1]= 'object_id;object_code;object_name;ship_to_addtext;bill_to_object;object_name_1;object_code_1;bill_to_addtext;'
istr_dwo_related[1].s_related_obj_column_copy[1] += 'due_date;payment_term_code;payment_term_name;payment_method_code;payment_method_name;'
istr_dwo_related[1].s_related_obj_column_copy[1] += 'uom_code;currency_id;exchange_rate;include_tax_yn;note;payment_term;payment_method;delivery_mode_code;delivery_mode_name;delivery_mode;contact_name;contact_id'


istr_dwo_related[1].s_main_obj_dwo_copy[2] = 'd_so_line_grid'// datawindow copy từ
istr_dwo_related[1].s_main_obj_column_copy[2] =  'line_no;ITEM_ID;item_code;LINE_TEXT;NOTE;other_note;act_qty;act_qty;act_price;act_price;act_amount;act_amount;markup_pct;markup_amt;comm_pct;comm_amt;not_invoice;foc_yn;'+&
																			'uom_code;TRANS_UOM;markup_return;SALES_PERSON;staff_name;base_price;base_amount;amount_ex_tax;act_amount_ex_tax;CONFIRM_RECEIVE_DATE;REQUEST_RECEIVE_DATE;' +&
...
istr_dwo_related[1].s_related_obj_column_copy[2] = 'line_no;ITEM_ID;object_code;LINE_TEXT;NOTE;other_note;QTY;act_qty;price;act_price;amount;act_amount;markup_pct;markup_amt;comm_pct;comm_amt;not_invoice;foc_yn;'+&
																		'uom_code;TRANS_UOM;markup_return;SALES_PERSON;staff_name;base_price;base_amount;amount_ex_tax;act_amount_ex_tax;CONFIRM_RECEIVE_DATE;REQUEST_RECEIVE_DATE;' +&
...
istr_dwo_related[2].s_main_obj_dwo = istr_dwo[2].s_dwo_default
...
istr_dwo_related[4].s_text = 'In bảng báo giá(VNĐ)'
...
if	gdb_branch = 24088840 then
	istr_dwo_related[7].s_related_obj_name = 'b_view'
	istr_dwo_related[7].s_main_obj_dwo = istr_dwo[1].s_dwo_default
	istr_dwo_related[7].s_main_obj_column = 'id'
	istr_dwo_related[7].s_related_obj_dwo = 'dv_qt_kni_eng_form'
	istr_dwo_related[7].s_related_obj_column = 'id'
	istr_dwo_related[7].s_relatedtext_column = 'code'
	istr_dwo_related[7].s_text = 'In bảng báo giá Dao-Dầu(eng)'

	istr_dwo_related[8].s_related_obj_name = 'b_view'
	istr_dwo_related[8].s_main_obj_dwo = istr_dwo[1].s_dwo_default
	istr_dwo_related[8].s_main_obj_column = 'id'
	istr_dwo_related[8].s_related_obj_dwo = 'dv_qt_kni_form'
	istr_dwo_related[8].s_related_obj_column = 'id'
	istr_dwo_related[8].s_relatedtext_column = 'code'
	istr_dwo_related[8].s_text = 'In bảng báo giá Dao-Dầu(vn)'
else  // if gdb_branch = 11006119 then
	istr_dwo_related[7].s_related_obj_name = 'b_view'
	istr_dwo_related[7].s_main_obj_dwo = istr_dwo[1].s_dwo_default
	istr_dwo_related[7].s_main_obj_column = 'id'
	istr_dwo_related[7].s_related_obj_dwo = 'dv_qt_kni_eng_asv_form'
	istr_dwo_related[7].s_related_obj_column = 'id'
	istr_dwo_related[7].s_relatedtext_column = 'code'
	istr_dwo_related[7].s_text = 'In bảng báo giá Dao-Dầu(eng)'
	...
	istr_dwo_related[8].s_main_obj_dwo = istr_dwo[1].s_dwo_default
	istr_dwo_related[8].s_main_obj_column = 'id'
	istr_dwo_related[8].s_related_obj_dwo = 'dv_qt_kni_asv_form'
	istr_dwo_related[8].s_related_obj_column = 'id'
	istr_dwo_related[8].s_relatedtext_column = 'code'
	istr_dwo_related[8].s_text = 'In bảng báo giá Dao-Dầu(vn)'
end if
...
istr_dwo_related[9].s_main_obj_column_copy[1] = 'object_id;bill_to_object;PAYMENT_TERM;PAYMENT_METHOD;DELIVERY_MODE;REQUEST_SHIP_DATE;BILL_TO_ADDTEXT;CURRENCY_ID;EXCHANGE_RATE;'
istr_dwo_related[9].s_related_obj_dwo_copy[1] = 'd_order_form' // datawindow copy đến
istr_dwo_related[9].s_related_obj_column_copy[1]= 'object_id;bill_to_object;PAYMENT_TERM;PAYMENT_METHOD;DELIVERY_MODE;REQUEST_SHIP_DATE;BILL_TO_ADDTEXT;CURRENCY_ID;EXCHANGE_RATE;'

istr_dwo_related[9].s_main_obj_dwo_copy[2] = 'd_so_line_grid' // datawindow copy từ
istr_dwo_related[9].s_main_obj_column_copy[2] =  'line_no;ITEM_ID;LINE_TEXT;NOTE;QTY;price;amount;foc_yn;'+&
...
istr_dwo_related[9].s_related_obj_column_copy[2] = 'line_no;ITEM_ID;LINE_TEXT;NOTE;QTY;price;amount;foc_yn;'+&
...
istr_dwo_related[9].s_f_obj_column_chk[2] = 'ITEM_ID;PRICE;foc_yn;'
istr_dwo_related[9].s_t_obj_column_chk[2] = 'ITEM_ID;PRICE;foc_yn;'
...
//istr_dwo_related[9].s_main_obj_column_chk[3] = 'item_id;item_code;item_name;'
//istr_dwo_related[9].s_related_obj_column_chk[3] = 'item_id;object_code;line_text;'
...
istr_unit[1].s_dwo_handing = 'd_po_line_grid;d_po_line_grid;d_po_line_grid;d_po_line_grid;d_document_so_return_form;'
...
istr_unit[1].s_dwo_unit = 'd_document_so_return_form;d_document_so_return_form;d_document_so_return_form;d_document_so_return_form;d_document_so_return_form'
...
on c_so_return.create
call super::create
end on

on c_so_return.destroy
call super::destroy
end on
...
rpo_dw.setitem(vl_currentrow,'doc_type','SO_RETURN')
		...
		FOR li_idx = 1 to upperbound(istr_actionpane[]) 
			if istr_actionpane[li_idx].s_dwo_action = 'd_action_edit' then
				...
				if ldw_focus.dynamic f_get_ib_detail() then
					...
					if  ib_changed_dwo_4edit then
						istr_actionpane[li_idx].s_visible_buttons='b_add_multi;b_modify;b_detail;b_filteron;b_refresh;b_delete;b_cancel;b_send_2_approve;b_approve;b_reject;' //b_view_multi;b_copyt_multi;
					else
			...
			elseif  istr_actionpane[li_idx].s_dwo_action = 'd_action_related_object' then
				istr_actionpane[li_idx].s_visible_buttons =   'b_qt;b_goods_delivery;'
...
string			ls_cust_yn, ls_taxnumber, ls_addr, ls_ship_address, ls_contact_person, ls_phone, ls_currCode, ls_currName
...
if ldb_doc_id > 0 then
	...
	if ldb_extend_id > 0 then
		...
		VALUES (:ldb_extend_id, :ldb_doc_id, 'DOCUMENT',:gi_user_comp_id, :gdb_branch, :gi_userid, sysdate, :gi_userid, sysdate,'SO_RETURN', 1,
...
b_obj_instantiate		lbo_ins
	...
	if li_cnt > 0 then
		...
		from matching where t_doc_id = :ldb_doc_id and rownum=1 using it_transaction;	
		
		UPDATE document set status = 'new' where id = :ldb_f_doc_id using it_transaction;			
		//-- xoá --//
