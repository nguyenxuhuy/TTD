$PBExportHeader$ur_profit_loss.sru
forward
global type ur_profit_loss from b_report
end type
end forward

global type ur_profit_loss from b_report
end type
global ur_profit_loss ur_profit_loss
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_profit_loss_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_profit_loss_form'
...
istr_dwo[2].s_dwo_default = 'dp_profit_loss_form'
istr_dwo[2].s_dwo_form = 'dp_profit_loss_form'
...
on ur_profit_loss.create
call super::create
end on

on ur_profit_loss.destroy
call super::destroy
end on
...
istr_report.s_dwo_report = 'dr_profit_loss_form'
