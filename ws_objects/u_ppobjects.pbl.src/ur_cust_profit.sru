$PBExportHeader$ur_cust_profit.sru
forward
global type ur_cust_profit from b_report
end type
end forward

global type ur_cust_profit from b_report
end type
global ur_cust_profit ur_cust_profit
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_cust_profit_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_cust_profit_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo doanh số - chi phí từng khách hàng'
...
istr_dwo[2].s_dwo_default = 'dp_cust_profit_form'
istr_dwo[2].s_dwo_form = 'dp_cust_profit_form'
...
on ur_cust_profit.create
call super::create
end on

on ur_cust_profit.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo doanh số - chi phí từng khách hàng'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_cust_profit_form'
...
ls_options =  string( ldw_parm.getitemdatetime(ldw_parm.getrow(), 'a_s_date' ),'yyyymmddhhmmss')
return 0
end event
