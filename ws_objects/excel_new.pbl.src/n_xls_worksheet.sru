...
type ostr_colinfo from structure within n_xls_worksheet
end type
type ostr_selection from structure within n_xls_worksheet
end type
type ostr_panes from structure within n_xls_worksheet
end type
end forward
...
public n_xls_format invo_default_format
public n_xls_format invo_null_format
...
public function integer of_write (unsignedinteger ai_row, unsignedinteger ai_col, ref blob ab_unicode_str, n_xls_format anvo_format)
...
public function integer of_write (unsignedinteger ai_row, unsignedinteger ai_col1, n_xls_format anvo_format, unsignedinteger ai_col2)
...
public function integer of_merge_write (uint ai_first_row,uint ai_first_col,uint ai_last_row,uint ai_last_col,date ad_date,n_xls_format anvo_format);double ld_val
...
public function integer of_merge_write (uint ai_first_row,uint ai_first_col,uint ai_last_row,uint ai_last_col,datetime adt_datetime,n_xls_format anvo_format);double ld_val
time lt_time
string ls_time
integer li_hour
integer li_minute
...
public function integer of_merge_write (uint ai_first_row,uint ai_first_col,uint ai_last_row,uint ai_last_col,double adb_num,n_xls_format anvo_format);integer li_ret = 1
uint li_rwfirst
uint li_colfirst
uint li_rwlast
uint li_collast
...
public function integer of_merge_write (uint ai_first_row,uint ai_first_col,uint ai_last_row,uint ai_last_col,n_xls_format anvo_format);integer li_ret = 1
uint li_rwfirst
uint li_colfirst
uint li_rwlast
uint li_collast
...
public function integer of_merge_write (uint ai_first_row,uint ai_first_col,uint ai_last_row,uint ai_last_col,string as_str,n_xls_format anvo_format);return of_merge_write(ai_first_row,ai_first_col,ai_last_row,ai_last_col,invo_sub.of_ansi2unicode(as_str),anvo_format)
end function

public function integer of_merge_write (uint ai_first_row,uint ai_first_col,uint ai_last_row,uint ai_last_col,time at_time,n_xls_format anvo_format);double ld_val
integer li_hour
integer li_minute
integer li_second
...
public function integer of_set_column (unsignedinteger ai_firstcol, unsignedinteger ai_lastcol, double ad_width, n_xls_format anvo_format, boolean ab_hidden);integer li_ret = 1, li_index
double ld_width
uint li_i
ulong ll_key
n_xls_format lnvo_format
...
public function integer of_set_row_format (long al_row,n_xls_format anvo_format);integer li_ret = 1
uint li_height
boolean lb_hidden = false
...
public function integer of_write (uint ai_row,uint ai_col,date ad_date,n_xls_format anvo_format);double ld_val = 0
...
public function integer of_write (unsignedinteger ai_row, unsignedinteger ai_col, string as_str, n_xls_format anvo_format);if IsNull(as_str) or as_str ='' then
...
public function integer of_write (uint ai_row,uint ai_col,time at_time,n_xls_format anvo_format);double ld_val
integer li_hour
integer li_minute
integer li_second
...
protected function integer of_xf (unsignedinteger ai_row, unsignedinteger ai_col, n_xls_format anvo_format);uint li_xf = 15
ulong ll_key
...
public function integer of_write (unsignedinteger ai_row, unsignedinteger ai_col, ref blob ab_unicode_str, n_xls_format anvo_format);integer li_ret = 1
uint li_xf
ulong ll_sst_index
long ll_pos = 1
...
public function integer of_write (unsignedinteger ai_row, unsignedinteger ai_col1, n_xls_format anvo_format, unsignedinteger ai_col2);integer li_ret = 1
uint li_xf
integer i,li_count
