$PBExportHeader$ur_work_order_revenue.sru
forward
global type ur_work_order_revenue from b_report
end type
end forward

global type ur_work_order_revenue from b_report
end type
global ur_work_order_revenue ur_work_order_revenue
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_work_order_revenue_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_work_order_revenue_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo doanh số DV kỹ thuật'
...
istr_dwo[2].s_dwo_default = 'dp_work_order_revenue_form'
istr_dwo[2].s_dwo_form = 'dp_work_order_revenue_form'
...
on ur_work_order_revenue.create
call super::create
end on

on ur_work_order_revenue.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo doanh số DV kỹ thuật'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_work_order_revenue_form'
istr_report.b_multi_thread = false

end event

event e_window_e_preopen;call super::e_window_e_preopen;iw_display.dynamic f_set_ii_leftpart_width(4500)
