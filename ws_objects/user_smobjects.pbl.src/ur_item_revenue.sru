$PBExportHeader$ur_item_revenue.sru
forward
global type ur_item_revenue from b_report
end type
end forward

global type ur_item_revenue from b_report
end type
global ur_item_revenue ur_item_revenue
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_item_revenue_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_item_revenue_form'
...
istr_dwo[2].s_dwo_default = 'dp_item_revenue_form'
istr_dwo[2].s_dwo_form = 'dp_item_revenue_form'
...
on ur_item_revenue.create
call super::create
end on

on ur_item_revenue.destroy
call super::destroy
end on
...
istr_report.s_dwo_report = 'dr_item_revenue_form'
istr_report.s_pro_name = 'pkg_item_revenue.pro_item_revenue'
