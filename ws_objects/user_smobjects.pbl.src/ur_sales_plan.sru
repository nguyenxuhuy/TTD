$PBExportHeader$ur_sales_plan.sru
forward
global type ur_sales_plan from b_report
end type
end forward

global type ur_sales_plan from b_report
end type
global ur_sales_plan ur_sales_plan
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_sales_plan_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_sales_plan_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo doanh số kế hoạch'
...
istr_dwo[2].s_dwo_default = 'dp_sales_plan_form'
istr_dwo[2].s_dwo_form = 'dp_sales_plan_form'
...
on ur_sales_plan.create
call super::create
end on

on ur_sales_plan.destroy
call super::destroy
end on
