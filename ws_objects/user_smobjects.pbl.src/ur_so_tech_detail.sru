$PBExportHeader$ur_so_tech_detail.sru
forward
global type ur_so_tech_detail from b_report
end type
end forward

global type ur_so_tech_detail from b_report
end type
global ur_so_tech_detail ur_so_tech_detail
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_so_tech_detail_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_so_tech_detail_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách chi tiết công tác kỹ thuật'
...
istr_dwo[2].s_dwo_default = 'dp_so_tech_detail_form'
istr_dwo[2].s_dwo_form = 'dp_so_tech_detail_form'
...
on ur_so_tech_detail.create
call super::create
end on

on ur_so_tech_detail.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo danh sách chi tiết công tác kỹ thuật'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_so_tech_detail_form'
