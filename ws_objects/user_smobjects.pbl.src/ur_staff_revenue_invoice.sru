$PBExportHeader$ur_staff_revenue_invoice.sru
forward
global type ur_staff_revenue_invoice from b_report
end type
end forward

global type ur_staff_revenue_invoice from b_report
end type
global ur_staff_revenue_invoice ur_staff_revenue_invoice
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_staff_revenue_invoice_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_staff_revenue_invoice_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo doanh số nhân viên theo chứng từ'
...
istr_dwo[2].s_dwo_default = 'dp_staff_revenue_invoice_form'
istr_dwo[2].s_dwo_form = 'dp_staff_revenue_invoice_form'
...
on ur_staff_revenue_invoice.create
call super::create
end on

on ur_staff_revenue_invoice.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo doanh số nhân viên theo chứng từ'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_staff_revenue_invoice_form'
istr_report.s_pro_name = 'pkg_staff_revenue_so.pro_staff_revenue_so'
...
istr_report.sa_parm_name[5] = 'p_invoice_date'
...
ls_invoice_date = ldw_parm.getitemstring(ldw_parm.getrow(), 'p_invoice_date')
if isnull(ls_invoice_date) or ls_invoice_date = '' then 
	ldw_parm.setitem(ldw_parm.getrow(), 'p_invoice_date','Y')
end if
