$PBExportHeader$ur_qt_state.sru
forward
global type ur_qt_state from b_report
end type
end forward

global type ur_qt_state from b_report
end type
global ur_qt_state ur_qt_state
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_qt_state_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_qt_state_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo tình trạng báo giá theo nhân viên'
...
istr_dwo[2].s_dwo_default = 'dp_qt_state_form'
istr_dwo[2].s_dwo_form = 'dp_qt_state_form'
...
on ur_qt_state.create
call super::create
end on

on ur_qt_state.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo tình trạng báo giá theo nhân viên'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_qt_state_form'
