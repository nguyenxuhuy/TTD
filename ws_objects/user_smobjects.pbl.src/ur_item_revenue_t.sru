$PBExportHeader$ur_item_revenue_t.sru
forward
global type ur_item_revenue_t from b_report
end type
end forward

global type ur_item_revenue_t from b_report
end type
global ur_item_revenue_t ur_item_revenue_t
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_item_revenue_t_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_item_revenue_t_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo kết quả kinh doanh'
...
istr_dwo[2].s_dwo_default = 'dp_item_revenue_t_form'
istr_dwo[2].s_dwo_form = 'dp_item_revenue_t_form'
...
on ur_item_revenue_t.create
call super::create
end on

on ur_item_revenue_t.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo kết quả kinh doanh'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_item_revenue_t_form'
istr_report.s_pro_name = 'pkg_item_revenue_t.pro_item_revenue'
...
istr_report.sa_parm_name[5] = 'p_item_code'
istr_report.sa_parm_name[6] = 'p_invoice_date'
