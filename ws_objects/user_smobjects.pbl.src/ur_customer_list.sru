$PBExportHeader$ur_customer_list.sru
forward
global type ur_customer_list from b_report
end type
end forward

global type ur_customer_list from b_report
end type
global ur_customer_list ur_customer_list
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_customer_list_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_customer_list_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách khách hàng'
...
istr_dwo[2].s_dwo_default = 'dp_customer_list_form'
istr_dwo[2].s_dwo_form = 'dp_customer_list_form'
...
on ur_customer_list.create
call super::create
end on

on ur_customer_list.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo danh sách khách hàng'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_customer_list_form'
...
ls_active = ldw_parm.getitemstring(ldw_parm.getrow(), 'a_active')
if isnull(ls_active) then
	ls_active = '*'
	ldw_parm.setitem(ldw_parm.getrow(), 'a_active',ls_active)
end if
