$PBExportHeader$ur_work_order_detail.sru
forward
global type ur_work_order_detail from b_report
end type
end forward

global type ur_work_order_detail from b_report
end type
global ur_work_order_detail ur_work_order_detail
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_work_order_detail_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_work_order_detail_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách các phiếu YCDV'
...
istr_dwo[2].s_dwo_default = 'dp_work_order_detail_form'
istr_dwo[2].s_dwo_form = 'dp_work_order_detail_form'
...
on ur_work_order_detail.create
call super::create
end on

on ur_work_order_detail.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo danh sách các phiếu YCDV'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_work_order_detail_form'
istr_report.b_multi_thread = false

end event

event e_window_e_view_report;call super::e_window_e_view_report;t_dw_mpl	ldw_parm
string			ls_roster_yn,ls_customer_accept_yn

ldw_parm = iw_display.f_get_dw(istr_dwo[2].s_dwo_default)
ls_roster_yn = ldw_parm.getitemstring(ldw_parm.getrow(), 'a_roster_yn')
if isnull(ls_roster_yn) then
	ls_roster_yn = '%'
	ldw_parm.setitem(ldw_parm.getrow(), 'a_roster_yn',ls_roster_yn)
end if
ls_customer_accept_yn = ldw_parm.getitemstring(ldw_parm.getrow(), 'a_customer_accept_yn')
if isnull(ls_customer_accept_yn) then
	ls_customer_accept_yn = '%'
	ldw_parm.setitem(ldw_parm.getrow(), 'a_customer_accept_yn',ls_customer_accept_yn)
end if
return 0
end event
