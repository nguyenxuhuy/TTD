$PBExportHeader$ur_so_return_goods_receipt.sru
forward
global type ur_so_return_goods_receipt from b_report
end type
end forward

global type ur_so_return_goods_receipt from b_report
end type
global ur_so_return_goods_receipt ur_so_return_goods_receipt
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_so_return_goods_receipt_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_so_return_goods_receipt_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách đề xuất trả hàng và nhập kho trả hàng'
...
istr_dwo[2].s_dwo_default = 'dp_so_return_goods_receipt_form'
istr_dwo[2].s_dwo_form = 'dp_so_return_goods_receipt_form'
...
on ur_so_return_goods_receipt.create
call super::create
end on

on ur_so_return_goods_receipt.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo danh sách đề xuất trả hàng và nhập kho trả hàng'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_so_return_goods_receipt_form'
