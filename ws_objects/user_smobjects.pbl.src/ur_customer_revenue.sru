$PBExportHeader$ur_customer_revenue.sru
forward
global type ur_customer_revenue from b_report
end type
end forward

global type ur_customer_revenue from b_report
end type
global ur_customer_revenue ur_customer_revenue
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_customer_revenue_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_customer_revenue_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo doanh số khách hàng'
...
istr_dwo[2].s_dwo_default = 'dp_customer_revenue_form'
istr_dwo[2].s_dwo_form = 'dp_customer_revenue_form'
...
on ur_customer_revenue.create
call super::create
end on

on ur_customer_revenue.destroy
call super::destroy
end on

event constructor;call super::constructor;is_table = 'OBJECT_TRANS'
ib_changed_dwo_4edit = false
is_display_model = '1ddlb_2d_1tp'
ib_display_text = true
is_object_title = 'Báo cáo doanh số khách hàng'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_customer_revenue_form'
istr_report.s_pro_name = 'pkg_customer_revenue.pro_insert_cus_revenue'
istr_report.sa_parm_name[1] = 'p_s_date'
istr_report.sa_parm_name[2] = 'p_e_date'
istr_report.sa_parm_name[3] = 'p_manager_group_code'
istr_report.sa_parm_name[4] = 'p_customer_code'
istr_report.sa_parm_name[5] = 'p_sales_code'
