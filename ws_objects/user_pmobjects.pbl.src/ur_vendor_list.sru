$PBExportHeader$ur_vendor_list.sru
forward
global type ur_vendor_list from b_report
end type
end forward

global type ur_vendor_list from b_report
end type
global ur_vendor_list ur_vendor_list
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_vendor_list_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_vendor_list_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách nhà cung cấp'
...
istr_dwo[2].s_dwo_default = 'dp_vendor_list_form'
istr_dwo[2].s_dwo_form = 'dp_vendor_list_form'
...
on ur_vendor_list.create
call super::create
end on

on ur_vendor_list.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo danh sách nhà cung cấp'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_vendor_list_form'
