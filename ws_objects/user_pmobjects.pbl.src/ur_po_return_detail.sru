$PBExportHeader$ur_po_return_detail.sru
forward
global type ur_po_return_detail from b_report
end type
end forward

global type ur_po_return_detail from b_report
end type
global ur_po_return_detail ur_po_return_detail
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_po_return_detail_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_po_return_detail_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách đơn trả hàng'
...
istr_dwo[2].s_dwo_default = 'dp_po_return_detail_form'
istr_dwo[2].s_dwo_form = 'dp_po_return_detail_form'
...
public subroutine f_set_dwo_related ();istr_dwo_related[1].s_related_obj_name = 'u_po_return'					// đối tượng liên quan
istr_dwo_related[1].s_main_obj_dwo = 'dr_po_return_detail_form'		//datawindow quan hệ main
...
istr_dwo_related[1].s_text = 'Đơn trả hàng NCC'
...
on ur_po_return_detail.create
call super::create
end on

on ur_po_return_detail.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo danh sách đơn trả hàng'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_po_return_detail_form'
