$PBExportHeader$c_bank_voucher.sru
forward
global type c_bank_voucher from b_doc
end type
end forward

global type c_bank_voucher from b_doc
end type
global c_bank_voucher c_bank_voucher
...
public subroutine f_set_dwo_window ();istr_dwo[1].s_dwo_default =  'd_document_payment_grid'
istr_dwo[1].s_dwo_form = 'd_document_payment_form'
istr_dwo[1].s_dwo_grid = 'd_document_payment_grid'
...
istr_dwo[1].s_description = 'Sổ phụ ngân hàng chi'
...
//istr_dwo_related[3].s_main_obj_column_copy[1] =  'document_date'
//istr_dwo_related[3].s_related_obj_dwo_copy[1] = 'd_document_ap_grid' // datawindow copy đến
//istr_dwo_related[3].s_related_obj_column_copy[1] = 'document_date'

istr_dwo_related[3].s_main_obj_dwo_copy[1] = 'd_payment_line_grid' // datawindow copy từ
...
istr_dwo_related[3].s_match_f_dwo[1] = 'd_payment_line_grid'
...
istr_dwo_related[3].s_main_obj_dwo_copy[3] = 'd_pur_invoice_line_grid' // datawindow copy từ
istr_dwo_related[3].s_related_obj_dwo_copy[3] = 'd_payment_line_grid' // datawindow copy đến
istr_dwo_related[3].s_main_obj_column_copy[3] = 'subaccount_code;subaccount_name;SUBACCOUNT;' // cột copy từ
istr_dwo_related[3].s_related_obj_column_copy[3] = 'subaccount_code;subaccount_name;SUBACCOUNT;'
...
istr_dwo_related[3].s_main_obj_column_chk[4] = 'dr_cr_object'
istr_dwo_related[3].s_related_obj_column_chk[4] = 'OBJECT_ID'
//istr_dwo_related[3].b_copy_line[3] = true
/////// doan nay dung de cap nhat bang match khi update va xoa chagre line(phan bo phi)
istr_dwo_related[3].s_match_f_dwo[4] = 'd_payment_line_grid'
istr_dwo_related[3].s_match_t_dwo[4] = 'd_charge_line_grid'
istr_dwo_related[3].s_match_f_column[4] = 'amount;base_amount;'
istr_dwo_related[3].s_match_t_column[4] = 'CHARGE_AMT;CHARGE_BASE_AMT;'
istr_dwo_related[3].s_match_column[4] = 'trans_value;base_value;'
//////////////////////////////////////////////////////////////////////////////
istr_dwo_related[3].s_main_obj_dwo_copy[5] = 'd_invoice_pur_form' // datawindow copy từ
istr_dwo_related[3].s_main_obj_column_copy[5] ='currency_id;uom_code;exchange_rate;dr_cr_object;trans_date' // cột copy từ
istr_dwo_related[3].s_related_obj_dwo_copy[5] = 'd_payment_form' // datawindow copy đến
istr_dwo_related[3].s_related_obj_column_copy[5] = 'currency_id;uom_code;exchange_rate;invoice_object;trans_date'  // cột copy đến
istr_dwo_related[3].s_f_obj_column_chk[5] = ''
istr_dwo_related[3].s_t_obj_column_chk[5] = ''
istr_dwo_related[3].s_main_obj_column_chk[5] = ''
istr_dwo_related[3].s_related_obj_column_chk[5] = ''
istr_dwo_related[3].s_match_f_dwo[5] = ''
istr_dwo_related[3].s_match_t_dwo[5] = ''
istr_dwo_related[3].s_match_f_column[5] = ''
istr_dwo_related[3].s_match_t_column[5] = ''
istr_dwo_related[3].s_main_obj_column_sum[5] = ''
istr_dwo_related[3].s_related_obj_column_sum[5] = ''
istr_dwo_related[3].s_match_column[5] = ''
istr_dwo_related[3].s_f_obj_column_chk[5] = ''
istr_dwo_related[3].s_t_obj_column_chk[5] = ''
istr_dwo_related[3].b_copy_line[5] = false
istr_dwo_related[3].b_f_sum[5] = false
istr_dwo_related[3].b_copy_line[5] = false
...
istr_dwo_related[4].s_text = 'Hóa đơn bán:'
...
istr_dwo_related[7].s_main_obj_dwo = 'd_document_payment_grid'		//datawindow quan hệ main
...
istr_dwo_related[7].s_main_obj_dwo_copy[1] = 'd_payment_form' // datawindow copy từ
istr_dwo_related[7].s_main_obj_column_copy[1] ='invoice_object;dr_cr_object;currency_id;exchange_rate;'
istr_dwo_related[7].s_related_obj_dwo_copy[1] = 'd_payment_form' // datawindow copy đến
istr_dwo_related[7].s_related_obj_column_copy[1]='invoice_object;dr_cr_object;currency_id;exchange_rate;'
istr_dwo_related[7].s_related_obj_column_chk[1] = 'trans_date;'

istr_dwo_related[7].s_main_obj_dwo_copy[2] = 'd_payment_line_grid' // datawindow copy từ
istr_dwo_related[7].s_related_obj_dwo_copy[2] = 'd_payment_line_grid' // datawindow copy đến
istr_dwo_related[7].s_main_obj_column_copy[2] ='OBJECT_ID;amount;base_amount'  // cột copy từ
istr_dwo_related[7].s_related_obj_column_copy[2] = 'OBJECT_ID;amount;base_amount'  // cột copy đến

istr_dwo_related[7].s_main_obj_column_chk[2] = ''
istr_dwo_related[7].s_related_obj_column_chk[2] = ''
istr_dwo_related[7].s_match_f_dwo[2] = ''
istr_dwo_related[7].s_match_t_dwo[2] = ''
istr_dwo_related[7].s_match_t_dwo[2] =''
istr_dwo_related[7].s_match_f_column[2] = ''
istr_dwo_related[7].s_match_column[2] =''
...
on c_bank_voucher.create
call super::create
end on

on c_bank_voucher.destroy
call super::destroy
end on
...
//istr_actionpane[1].sa_sub_button[2]='b_view_payment;'
		...
		FOR li_idx = 1 to upperbound(istr_actionpane[]) 
			if istr_actionpane[li_idx].s_dwo_action = 'd_action_edit' then
				...
				if ldw_focus.dynamic f_get_ib_detail() then
					...
					if  ib_changed_dwo_4edit then
						istr_actionpane[li_idx].s_visible_buttons= 'b_add_multi;b_modify;b_filteron;b_refresh;b_delete;b_cancel;b_detail;b_post;b_account_view;'
					else
...
rpo_dw.setitem(vl_currentrow,'doc_type','BANK_VOUCHER')
...
if ldb_doc_id > 0 then
	...
	if ldb_extend_id > 0 then
		...
		VALUES(:ldb_extend_id, :ldb_doc_id, 'DOCUMENT',:gi_user_comp_id, :gdb_branch, :gi_userid, sysdate, :gi_userid, sysdate,'BANK_VOUCHER', 1,
