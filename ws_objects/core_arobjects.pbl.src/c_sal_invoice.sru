$PBExportHeader$c_sal_invoice.sru
forward
global type c_sal_invoice from b_doc
end type
end forward

global type c_sal_invoice from b_doc
end type
global c_sal_invoice c_sal_invoice
...
istr_actionpane[2].s_button_name =  'b_goods_receipt;b_receipt;b_bank_voucher;'
...
public subroutine f_set_dwo_window ();istr_dwo[1].s_dwo_default =  'd_document_ar_grid'
istr_dwo[1].s_dwo_form = 'd_document_ar_form'
istr_dwo[1].s_dwo_grid = 'd_document_ar_grid'
...
istr_dwo[1].s_description = 'Hóa đơn bán'
...
istr_unit[1].s_dwo_handing = 'd_sal_invoice_line_grid;d_sal_invoice_line_grid;d_sal_invoice_line_grid;d_sal_invoice_line_grid;d_document_ar_form;'
...
istr_unit[1].s_dwo_unit = 'd_sal_invoice_line_grid;d_document_ar_form;d_document_ar_form;d_document_ar_form;d_document_ar_form;'
...
istr_dwo_related[3].s_main_obj_dwo_copy[1] = 'd_document_ar_grid' // datawindow copy từ
istr_dwo_related[3].s_related_obj_dwo_copy[1] = 'd_document_payment_form' // datawindow copy đến
istr_dwo_related[3].s_main_obj_column_copy[1] ='exchange_rate;currency_id;'  // cột copy từ
istr_dwo_related[3].s_related_obj_column_copy[1] = 'exchange_rate;currency_id;'  // cột copy đến
istr_dwo_related[3].s_main_obj_column_chk[1] = ''
istr_dwo_related[3].s_related_obj_column_chk[1] = 'trans_date;dr_cr_object'
istr_dwo_related[3].b_f_sum[1] = true
istr_dwo_related[3].b_copy_line[1] = true

istr_dwo_related[3].s_main_obj_dwo_copy[2] = 'd_document_ar_form'
istr_dwo_related[3].s_related_obj_dwo_copy[2] = 'd_payment_line_grid'
istr_dwo_related[3].s_main_obj_column_copy[2] ='dr_cr_object;amount;amount;'
istr_dwo_related[3].s_related_obj_column_copy[2] = 'OBJECT_ID;amount;base_amount;'
istr_dwo_related[3].s_match_f_col_obj[2]=''
//istr_dwo_related[3].s_main_dr_cr_obj_dwo_sum[2]='d_invoice_pur_form'
...
istr_dwo_related[3].s_match_f_dwo[2] = 'd_document_ar_form'
istr_dwo_related[3].s_match_t_dwo[2] = 'd_payment_line_grid'
istr_dwo_related[3].s_match_f_column[2] = 'amount;amount'
...
istr_dwo_related[3].b_copy_line[2] = false
istr_dwo_related[3].b_f_sum[2] = false
istr_dwo_related[3].b_copy_line[2] = false

istr_dwo_related[4].s_related_obj_name = 'u_sal_invoice'					// đối tượng liên quan
...
istr_dwo_related[4].s_text = 'Nhân bản từ hóa đơn bán:'

/////////////////////////////////////////////////////////////////////
istr_dwo_related[4].s_main_obj_dwo_copy[1] = 'd_invoice_sal_form' // datawindow copy từ
...
istr_dwo_related[4].s_related_obj_dwo_copy[1] = 'd_invoice_sal_form' // datawindow copy đến
...
istr_dwo_related[4].s_related_obj_column_chk[1] = 'trans_date;'

istr_dwo_related[4].s_main_obj_dwo_copy[2] = 'd_sal_invoice_line_grid' // datawindow copy từ
...
istr_dwo_related[4].s_main_obj_column_copy[2]+='subaccount;amount_ex_tax;base_amount_ex_tax;PRICE_EX_TAX;'
...
istr_dwo_related[4].s_related_obj_column_copy[2]+='subaccount;amount_ex_tax;base_amount_ex_tax;PRICE_EX_TAX;'

istr_dwo_related[4].s_main_obj_dwo_copy[3] = 'd_tax_line_grid' // datawindow copy từ
istr_dwo_related[4].s_main_obj_column_copy[3] = 'tax_pct;tax_amt;tax_correction;tax_id;TRANS_CURRENCY;exchange_rate;'
istr_dwo_related[4].s_related_obj_dwo_copy[3] = 'd_tax_line_grid' // datawindow copy đến
istr_dwo_related[4].s_related_obj_column_copy[3] = 'tax_pct;tax_amt;tax_correction;tax_id;TRANS_CURRENCY;exchange_rate;'
//istr_dwo_related[4].s_main_obj_column_chk[3] = 'item_id;item_code;item_name;'
//istr_dwo_related[4].s_related_obj_column_chk[3] = 'item_id;object_code;line_text;'
...
istr_dwo_related[7].s_related_obj_name = 'u_bank_voucher'					// đối tượng liên quan
...
istr_dwo_related[7].s_related_obj_dwo = 'd_document_payment_grid'	// datawindow quan hệ đến
...
istr_dwo_related[7].s_text = 'Phiếu chi từ:'

istr_dwo_related[7].s_main_obj_dwo_copy[1] = 'd_document_ar_grid' // datawindow copy từ
istr_dwo_related[7].s_related_obj_dwo_copy[1] = 'd_document_payment_form' // datawindow copy đến
istr_dwo_related[7].s_main_obj_column_copy[1] ='exchange_rate;currency_id;'  // cột copy từ
istr_dwo_related[7].s_related_obj_column_copy[1] = 'exchange_rate;currency_id;'  // cột copy đến
istr_dwo_related[7].s_main_obj_column_chk[1] = ''
istr_dwo_related[7].s_related_obj_column_chk[1] = 'trans_date;dr_cr_object'
istr_dwo_related[7].b_f_sum[1] = true
istr_dwo_related[7].b_copy_line[1] = true

istr_dwo_related[7].s_main_obj_dwo_copy[2] = 'd_document_ar_form'
istr_dwo_related[7].s_related_obj_dwo_copy[2] = 'd_payment_line_grid'
istr_dwo_related[7].s_main_obj_column_copy[2] ='dr_cr_object;amount;amount;'
istr_dwo_related[7].s_related_obj_column_copy[2] = 'OBJECT_ID;amount;base_amount;'
istr_dwo_related[7].s_match_f_col_obj[2]=''
...
istr_dwo_related[7].s_match_f_dwo[2] = 'd_document_ar_form'
istr_dwo_related[7].s_match_t_dwo[2] = 'd_payment_line_grid'
istr_dwo_related[7].s_match_f_column[2] = 'amount;amount'
istr_dwo_related[7].s_match_t_column[2] = 'amount;base_amount'
istr_dwo_related[7].s_match_column[2] = 'trans_value;base_value'

istr_dwo_related[7].s_main_obj_column_sum[2] = ''
istr_dwo_related[7].s_related_obj_column_sum[2] = ''
istr_dwo_related[7].s_f_obj_column_chk[2] = ''
istr_dwo_related[7].s_t_obj_column_chk[2] = ''
istr_dwo_related[7].b_copy_line[2] = false
istr_dwo_related[7].b_f_sum[2] = false
istr_dwo_related[7].b_copy_line[2] = false
...
istr_dwo_related[12].s_related_obj_dwo = 'dv_invoice_goods_delivery_price_form'	// datawindow quan hệ đến
istr_dwo_related[12].s_related_obj_column = 'id'			// cột quan hệ đến
istr_dwo_related[12].s_relatedtext_column = 'code'					
istr_dwo_related[12].s_text = 'Phiếu giao hàng có giá'
...
istr_dwo_related[13].s_related_obj_dwo = 'dv_invoice_goods_delivery_form'	// datawindow quan hệ đến
istr_dwo_related[13].s_related_obj_column = 'id'			// cột quan hệ đến
istr_dwo_related[13].s_relatedtext_column = 'code'					
istr_dwo_related[13].s_text = 'Phiếu giao hàng SL'
...
istr_ds_4_posting.ds_details[1].dataobject =  'd_invoice_sal_form'
istr_ds_4_posting.s_dataobject_str += 'd_invoice_sal'+'['+string(1)+']'
istr_ds_4_posting.ds_master[1] = create t_ds_db
istr_ds_4_posting.ds_master[1].dataobject = 'd_document_ar_form'
...
istr_ds_4_posting.ds_details[li_idx].dataobject =  'd_sal_invoice_line_grid'
istr_ds_4_posting.s_dataobject_str += 'd_sal_invoice_line' +'['+string(li_idx)+']'
istr_ds_4_posting.ds_master[li_idx] = create t_ds_db
istr_ds_4_posting.ds_master[li_idx].dataobject = 'd_invoice_sal_form'	
...
istr_ds_4_posting.ds_master[li_idx] = create t_ds_db
istr_ds_4_posting.ds_master[li_idx].dataobject = 'd_sal_invoice_line_grid'	
istr_ds_4_posting.s_join_detail[li_idx] =''
...
on c_sal_invoice.create
call super::create
end on

on c_sal_invoice.destroy
call super::destroy
end on
...
istr_actionpane[1].sa_sub_button[2]='b_copyt_receipt;b_copyt_bank_voucher;'
istr_actionpane[1].sa_sub_button[3]='b_view_invoice_goods_delivery_price;b_view_invoice_goods_delivery;'
		...
		FOR li_idx = 1 to upperbound(istr_actionpane[]) 
			if istr_actionpane[li_idx].s_dwo_action = 'd_action_edit' then
				...
				if ldw_focus.dynamic f_get_ib_detail() then
					...
					if  ib_changed_dwo_4edit then
						istr_actionpane[li_idx].s_visible_buttons= 'b_add_multi;b_modify;b_filteron;b_refresh;b_delete;b_cancel;b_detail;b_copyt_multi;b_post;b_account_view;b_view_multi;'
					else
						istr_actionpane[li_idx].s_visible_buttons='b_add_multi;b_modify;b_filteron;b_refresh;b_delete;b_cancel;b_detail;b_allocate;b_copyt_multi;b_post;b_account_view;b_view_multi;'
					end if
				end if
			elseif  istr_actionpane[li_idx].s_dwo_action = 'd_action_related_object' then
				istr_actionpane[li_idx].s_visible_buttons =   'b_so;b_goods_receipt;b_receipt;b_bank_voucher;'
...
rpo_dw.setitem(vl_currentrow,'doc_type','SAL_INVOICE')
...
event e_window_e_preunpost;call super::e_window_e_preunpost;int					li_cnt
long				ll_rtn, ll_row
string				ls_status, ls_f_doc_code, ls_t_doc_code, ls_t_table
double			ldb_doc_id
decimal			ldc_qty
...
if ldw_main.getrow( ) > 0 then
	...
	select count(t_doc_id) into :li_cnt
	from matching 
	where f_doc_id= :ldb_doc_id using it_transaction;
	if li_cnt > 0 then
		select d.code into :ls_t_doc_code
			from matching m join document d on d.id = m.t_doc_id
			where m.f_doc_id= :ldb_doc_id
			and rownum=1
			using it_transaction;
		gf_messagebox('m.c_pur_invoice.e_window_e_preunpost.01','Thông báo','Phiếu đã kết với phiếu: '+ ls_t_doc_code+ ' nên không được sửa ghi sổ' ,'stop','ok',1)
		return -1
	end if
end if
return 0
...
if ldb_doc_id > 0 then
	...
	if rpo_dw.describe('loc_id.coltype') = 'number' then
		...
		if isnull(ldb_transport_id) then ldb_transport_id = 0
	end if
	...
	if ldb_extend_id > 0 then
		...
		VALUES(:ldb_extend_id, :ldb_doc_id, 'DOCUMENT',:gi_user_comp_id, :gdb_branch, :gi_userid, sysdate, :gi_userid, sysdate,'SAL_INVOICE', 1,
...
b_obj_instantiate		lbo_ins
	...
	if ldb_extend_id > 0 then
		...
		//-- PO_LINE--//
		DELETE  sal_invoice_line where object_ref_id = :ldb_extend_id using it_transaction;
		//-- TAX_LINE--//
...
if vs_objectname_to = 'u_receipt' or vs_objectname_to = 'u_bank_voucher'  then
	ldw_main = iw_display.f_get_dwmain( )
	if ldw_main.getrow()> 0 then
		if ldw_main.getitemstring( ldw_main.getrow(), 'status') = 'new' then
			gf_messagebox('m.c_sal_invoice.e_w_e_precopy_to.01','Thông báo','Hoá đơn chưa ghi sổ','exclamation','ok',1)
			return -1
		end if
	end if
end if
