$PBExportHeader$c_item_interface_bk.sru
forward
global type c_item_interface_bk from b_interface
end type
end forward
...
global c_item_interface_bk c_item_interface_bk
...
if ldw_interface.dataobject = istr_dwo[2].s_dwo_default then	
...
istr_dwo[2].s_dwo_default = 'd_item_interface_bk_grid' 
istr_dwo[2].s_dwo_form = ''
istr_dwo[2].s_dwo_grid = 'd_item_interface_bk_grid'
...
on c_item_interface_bk.create
call super::create
end on

on c_item_interface_bk.destroy
call super::destroy
end on
...
is_object_title = 'Chuyển sản phẩm hàng hóa dịch vụ tạm thành chính thức'
...
if rpo_dw.dataobject = 'd_item_interface_parm_form' then
	...
	if vs_editdata <>'' then
		if vs_editdata = 'd_item_interface_grid' then vs_editdata = 'd_item_interface_bk_grid'
