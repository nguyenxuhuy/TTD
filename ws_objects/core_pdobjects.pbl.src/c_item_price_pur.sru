$PBExportHeader$c_item_price_pur.sru
forward
global type c_item_price_pur from s_object_display
end type
end forward
...
global c_item_price_pur c_item_price_pur
...
public subroutine f_set_dwo_window ();istr_dwo[1].s_dwo_default =  'd_item_purchase_price_grid'
istr_dwo[1].s_dwo_form = ''
istr_dwo[1].s_dwo_grid = 'd_item_purchase_price_grid'
...
istr_dwo[1].s_description = 'Bảng giá mua hàng hóa'
...
on c_item_price_pur.create
call super::create
end on

on c_item_price_pur.destroy
call super::destroy
end on
...
is_object_title = 'Bảng giá mua hàng hóa'

istr_actionpane[1].s_dwo_action = 'd_action_edit'
istr_actionpane[1].s_button_name = 'b_refresh;b_filteron;b_calculator_price;b_query;'
...
if isvalid(ldw_focus) then
	...
	FOR li_idx = 1 to upperbound(istr_actionpane[]) 
		if istr_actionpane[li_idx].s_dwo_action = 'd_action_edit' then
			istr_actionpane[li_idx].s_visible_buttons='b_add;b_modify;b_refresh;b_filteron;'
		end if				
	NEXT
