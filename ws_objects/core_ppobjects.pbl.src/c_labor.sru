$PBExportHeader$c_labor.sru
forward
global type c_labor from s_object_display
end type
end forward

global type c_labor from s_object_display
end type
global c_labor c_labor
...
istr_dwo[1].s_dwo_details = 'd_labour_form;'
...
istr_dwo[1].s_description = 'Nhân công'


istr_dwo[2].s_dwo_default =  'd_labour_form'
istr_dwo[2].s_dwo_form = 'd_labour_form'
...
istr_dwo[2].s_description = 'Nhân công'
...
if pos(rpo_dw.dataobject, 'd_object_') > 0 then
	ldw_handle = iw_display.dynamic f_get_dw('d_labour_form')
