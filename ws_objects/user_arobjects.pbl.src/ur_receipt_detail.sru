$PBExportHeader$ur_receipt_detail.sru
forward
global type ur_receipt_detail from b_report
end type
end forward

global type ur_receipt_detail from b_report
end type
global ur_receipt_detail ur_receipt_detail
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_receipt_detail_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_receipt_detail_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách phiếu thu tiền mặt'
...
istr_dwo[2].s_dwo_default = 'dp_receipt_detail_form'
istr_dwo[2].s_dwo_form = 'dp_receipt_detail_form'
...
istr_dwo_related[1].s_main_obj_dwo = 'dr_receipt_detail_form'		//datawindow quan hệ main
...
istr_dwo_related[1].s_text = 'Phiếu thu tiền mặt'
...
on ur_receipt_detail.create
call super::create
end on

on ur_receipt_detail.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo danh sách phiếu thu tiền mặt'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_receipt_detail_form'
