$PBExportHeader$ur_customer_balance_item_origin.sru
forward
global type ur_customer_balance_item_origin from b_report
end type
end forward

global type ur_customer_balance_item_origin from b_report
end type
global ur_customer_balance_item_origin ur_customer_balance_item_origin
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_customer_balance_item_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_customer_balance_item_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo chi tiết công nợ khách hàng theo mặt hàng'
...
istr_dwo_related[1].s_main_obj_dwo = 'dr_customer_balance_item_form'		//datawindow quan hệ main
...
istr_dwo_related[2].s_main_obj_dwo = 'dr_customer_balance_item_form'		//datawindow quan hệ main
...
on ur_customer_balance_item_origin.create
call super::create
end on

on ur_customer_balance_item_origin.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo chi tiết công nợ khách hàng theo mặt hàng'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_customer_balance_item_form'
istr_report.s_pro_name = 'pkg_customer_balance_item.pro_cus_bal_item'
