$PBExportHeader$u_detail_receipt.sru
forward
global type u_detail_receipt from b_detail
end type
end forward
...
global u_detail_receipt u_detail_receipt
...
on u_detail_receipt.create
call super::create
end on

on u_detail_receipt.destroy
call super::destroy
end on
