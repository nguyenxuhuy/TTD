$PBExportHeader$ur_customer_overdue_salesper_group.sru
forward
global type ur_customer_overdue_salesper_group from b_report
end type
end forward

global type ur_customer_overdue_salesper_group from b_report
end type
global ur_customer_overdue_salesper_group ur_customer_overdue_salesper_group
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_customer_overdue_salesper_group_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_customer_overdue_salesper_group_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo công nợ khách hàng theo nhóm'
...
on ur_customer_overdue_salesper_group.create
call super::create
end on

on ur_customer_overdue_salesper_group.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo công nợ khách hàng theo nhóm'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_customer_overdue_salesper_group_form'
