$PBExportHeader$ur_bank_voucher_detail.sru
forward
global type ur_bank_voucher_detail from b_report
end type
end forward

global type ur_bank_voucher_detail from b_report
end type
global ur_bank_voucher_detail ur_bank_voucher_detail
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_bank_voucher_detail_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_bank_voucher_detail_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách phiếu sổ phụ NH thu'
...
istr_dwo[2].s_dwo_default = 'dp_bank_voucher_detail_form'
istr_dwo[2].s_dwo_form = 'dp_bank_voucher_detail_form'
...
public subroutine f_set_dwo_related ();istr_dwo_related[1].s_related_obj_name = 'u_bank_voucher'					// đối tượng liên quan
istr_dwo_related[1].s_main_obj_dwo = 'dr_bank_voucher_detail_form'		//datawindow quan hệ main
istr_dwo_related[1].s_main_obj_column = 'receipt_code'			// cột quan hệ của main
...
istr_dwo_related[1].s_relatedtext_column = 'receipt_code'					
istr_dwo_related[1].s_text = 'Sổ phụ ngân hàng thu'
...
on ur_bank_voucher_detail.create
call super::create
end on

on ur_bank_voucher_detail.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo danh sách phiếu sổ phụ NH thu'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_bank_voucher_detail_form'
...
event e_window_e_preopen;call super::e_window_e_preopen;iw_display.dynamic f_set_ii_leftpart_width(4100)
