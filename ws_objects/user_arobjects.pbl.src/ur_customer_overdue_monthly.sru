$PBExportHeader$ur_customer_overdue_monthly.sru
forward
global type ur_customer_overdue_monthly from b_report
end type
end forward

global type ur_customer_overdue_monthly from b_report
end type
global ur_customer_overdue_monthly ur_customer_overdue_monthly
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_customer_overdue_monthly_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_customer_overdue_monthly_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo công nợ khách hàng theo tháng'
...
on ur_customer_overdue_monthly.create
call super::create
end on

on ur_customer_overdue_monthly.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo công nợ khách hàng theo tháng'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_customer_overdue_monthly_form'
