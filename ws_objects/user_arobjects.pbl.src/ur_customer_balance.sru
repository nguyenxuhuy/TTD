$PBExportHeader$ur_customer_balance.sru
forward
global type ur_customer_balance from b_report
end type
end forward

global type ur_customer_balance from b_report
end type
global ur_customer_balance ur_customer_balance
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_customer_balance_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_customer_balance_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo công nợ khách hàng'
...
istr_dwo[2].s_dwo_default = 'dp_customer_balance_form'
istr_dwo[2].s_dwo_form = 'dp_customer_balance_form'
...
public subroutine f_set_dwo_related ();istr_dwo_related[1].s_related_obj_name = 'ur_customer_balance_detail'					// đối tượng liên quan
istr_dwo_related[1].s_main_obj_dwo = 'dr_customer_balance_form'		//datawindow quan hệ main
istr_dwo_related[1].s_main_obj_column = 'object_code'			// cột quan hệ của main
istr_dwo_related[1].s_related_obj_dwo = 'dp_customer_balance_detail_form'	// datawindow quan hệ đến
...
istr_dwo_related[1].s_main_obj_dwo_copy[1] = 'dp_customer_balance_form' // datawindow copy từ
istr_dwo_related[1].s_main_obj_column_copy[1] ='p_s_date;p_e_date;p_currency_type;p_account_code;'
istr_dwo_related[1].s_related_obj_dwo_copy[1] = 'dp_customer_balance_detail_form' 
istr_dwo_related[1].s_related_obj_column_copy[1]='p_s_date;p_e_date;p_currency_type;p_account_code;'
end subroutine

on ur_customer_balance.create
call super::create
end on

on ur_customer_balance.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo công nợ khách hàng'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_customer_balance_form'
istr_report.s_pro_name = 'pkg_customer_balance.pro_customer_balance'
...
ldw_parm= this.iw_display.f_get_dw( 'dp_customer_balance_form')
