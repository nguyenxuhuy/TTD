$PBExportHeader$ur_customer_balance_item_gr.sru
forward
global type ur_customer_balance_item_gr from b_report
end type
end forward

global type ur_customer_balance_item_gr from b_report
end type
global ur_customer_balance_item_gr ur_customer_balance_item_gr
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_customer_balance_item_gr_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_customer_balance_item_gr_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo chi tiết công nợ khách hàng theo nhóm hàng'
...
on ur_customer_balance_item_gr.create
call super::create
end on

on ur_customer_balance_item_gr.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo chi tiết công nợ khách hàng theo nhóm hàng'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_customer_balance_item_gr_form'
istr_report.s_pro_name = 'pkg_customer_balance_item_gr.pro_cus_bal_item'
