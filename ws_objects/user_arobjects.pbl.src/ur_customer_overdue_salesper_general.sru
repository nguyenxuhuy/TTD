$PBExportHeader$ur_customer_overdue_salesper_general.sru
forward
global type ur_customer_overdue_salesper_general from b_report
end type
end forward

global type ur_customer_overdue_salesper_general from b_report
end type
global ur_customer_overdue_salesper_general ur_customer_overdue_salesper_general
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_customer_overdue_salesper_general_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_customer_overdue_salesper_general_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo tổng hợp công nợ theo nhân viên'
...
istr_dwo[2].s_dwo_default = 'dp_customer_overdue_form'
istr_dwo[2].s_dwo_form = 'dp_customer_overdue_form'
...
on ur_customer_overdue_salesper_general.create
call super::create
end on

on ur_customer_overdue_salesper_general.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo tổng hợp công nợ theo nhân viên'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_customer_overdue_salesper_general_form'
istr_report.s_pro_name = 'pkg_customer_overdue.pro_customer_overdue'
istr_report.sa_parm_name[1] = 'p_s_date'
istr_report.sa_parm_name[2] = 'p_e_date'
istr_report.sa_parm_name[3] = 'p_object'
istr_report.sa_parm_name[4] = 'p_staff_code'
istr_report.sa_parm_name[5] = 'p_step'
