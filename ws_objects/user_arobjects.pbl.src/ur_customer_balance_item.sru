$PBExportHeader$ur_customer_balance_item.sru
forward
global type ur_customer_balance_item from b_report
end type
end forward

global type ur_customer_balance_item from b_report
end type
global ur_customer_balance_item ur_customer_balance_item
...
istr_dwo[2].s_dwo_default = 'dp_customer_balance_item_form'
istr_dwo[2].s_dwo_form = 'dp_customer_balance_item_form'
...
on ur_customer_balance_item.create
call super::create
end on

on ur_customer_balance_item.destroy
call super::destroy
end on
...
ldw_parm= this.iw_display.f_get_dw( 'dp_customer_balance_item_form')
