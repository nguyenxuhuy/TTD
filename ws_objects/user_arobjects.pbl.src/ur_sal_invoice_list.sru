$PBExportHeader$ur_sal_invoice_list.sru
forward
global type ur_sal_invoice_list from b_report
end type
end forward

global type ur_sal_invoice_list from b_report
end type
global ur_sal_invoice_list ur_sal_invoice_list
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_sal_invoice_list_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_sal_invoice_list_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách chi tiết hóa đơn'
...
istr_dwo[2].s_dwo_default = 'dp_sal_invoice_list_form'
istr_dwo[2].s_dwo_form = 'dp_sal_invoice_list_form'
...
istr_dwo_related[1].s_main_obj_dwo = 'dr_sal_invoice_list_form'		//datawindow quan hệ main
...
on ur_sal_invoice_list.create
call super::create
end on

on ur_sal_invoice_list.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo danh sách chi tiết hóa đơn'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_sal_invoice_list_form'
