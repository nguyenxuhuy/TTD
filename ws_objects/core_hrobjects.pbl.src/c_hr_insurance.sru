$PBExportHeader$c_hr_insurance.sru
forward
global type c_hr_insurance from s_object_display
end type
end forward

global type c_hr_insurance from s_object_display
end type
global c_hr_insurance c_hr_insurance
...
public subroutine f_set_dwo_window ();istr_dwo[1].s_dwo_default =  'd_insurance_hdr_grid'
istr_dwo[1].s_dwo_form = ''
istr_dwo[1].s_dwo_grid = 'd_insurance_hdr_grid'
istr_dwo[1].b_master = true
istr_dwo[1].b_detail = false
istr_dwo[1].b_cascade_del = true
istr_dwo[1].s_dwo_details = 'd_insurance_line_grid;'
...
istr_dwo[1].s_description = 'Các loại bảo hiểm'

istr_dwo[2].s_dwo_default =  'd_insurance_line_grid'
istr_dwo[2].s_dwo_form = ''
istr_dwo[2].s_dwo_grid = 'd_insurance_line_grid'
istr_dwo[2].b_detail = true
istr_dwo[2].b_master = false
istr_dwo[2].b_cascade_del = false
istr_dwo[2].b_shared = false
istr_dwo[2].s_dwo_master = 'd_insurance_hdr_grid;'
...
istr_dwo[2].s_description = 'Quy định bảo hiểm'
istr_dwo[2].s_pic_ref_table = ''
istr_dwo[2].s_pic_ref_field = ''

end subroutine

on c_hr_insurance.create
call super::create
end on

on c_hr_insurance.destroy
call super::destroy
end on
...
is_object_title = 'Các loại bảo hiểm'
...
iw_display.dynamic f_set_ii_upperpart_height(iw_display.ii_resize_height*1/2)
