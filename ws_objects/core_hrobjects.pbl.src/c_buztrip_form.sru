$PBExportHeader$c_buztrip_form.sru
forward
global type c_buztrip_form from s_object_display
end type
end forward
...
global c_buztrip_form c_buztrip_form
...
istr_dwo[1].s_description = 'Công tác'
...
istr_dwo[2].s_dwo_details = 'd_staff_buztrip_day_grid'
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default =  'd_staff_buztrip_day_grid'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = ''
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_grid = 'd_staff_buztrip_day_grid'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Chi tiết công tác'
end subroutine

on c_buztrip_form.create
call super::create
end on

on c_buztrip_form.destroy
call super::destroy
end on
...
if pos(rpo_dw.dataobject,'d_document_leave_grid') > 0 then	 
	...
	rpo_dw.setitem( vl_currentrow, 'doc_type', 'BUZTRIP_FORM')
	...
	ldw_form.setitem( ll_insertrow, 'doc_type', 'BUZTRIP_FORM')
