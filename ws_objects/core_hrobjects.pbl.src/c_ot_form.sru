$PBExportHeader$c_ot_form.sru
forward
global type c_ot_form from s_object_display
end type
end forward
...
istr_dwo[1].s_description = 'Tăng ca'
...
istr_dwo[2].s_dwo_details = 'd_staff_ot_day_grid'
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default =  'd_staff_ot_day_grid'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = ''
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_grid = 'd_staff_ot_day_grid'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Chi tiết tăng ca'
end subroutine
...
if pos(rpo_dw.dataobject,'d_document_leave_grid') > 0 then	 
	...
	rpo_dw.setitem( vl_currentrow, 'doc_type', 'OT_FORM')
	...
	ldw_form.setitem( ll_insertrow, 'doc_type', 'OT_FORM')
