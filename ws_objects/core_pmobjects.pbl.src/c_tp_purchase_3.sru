$PBExportHeader$c_tp_purchase_3.sru
forward
global type c_tp_purchase_3 from t_tp
end type
type dw_2 from t_dw_pos within c_tp_purchase_3
end type
type dw_1 from t_dw_pos within c_tp_purchase_3
end type
end forward
...
global c_tp_purchase_3 c_tp_purchase_3

on c_tp_purchase_3.create
int iCurrent
call super::create
...
this.setitem( vl_row , 'delivery_mode', 25555419 )
this.setitem( vl_row , 'delivery_mode_code', 'Mua lẻ' )
