...
forward prototypes
public subroutine f_set_info_mail (string vs_from_mail, string vs_from_name, string vs_to_mail, string vs_to_name, string vs_cc_mail, string vs_cc_name, string vs_subject, string vs_body, string vs_attach_file)
end prototypes

public subroutine f_set_info_mail (string vs_from_mail, string vs_from_name, string vs_to_mail, string vs_to_name, string vs_cc_mail, string vs_cc_name, string vs_subject, string vs_body, string vs_attach_file);
this.event constructor( )
sle_sender_email.text = vs_from_mail
sle_sender_name.text = vs_from_name
sle_recip_email.text = vs_to_mail
sle_recip_name.text = vs_to_name
sle_cc_email.text = vs_cc_mail
sle_cc_name.text = vs_cc_name
sle_subject.text = vs_subject
mle_body.text = vs_body
lb_attachments.additem(vs_attach_file)
return
end subroutine
