$PBExportHeader$s_w_multi_popup_rb.srw
forward
global type s_w_multi_popup_rb from s_w_multi_rb
end type
type rbb_1 from u_rbb within s_w_multi_popup_rb
end type
end forward
...
global s_w_multi_popup_rb s_w_multi_popup_rb
...
type st_1 from s_w_multi_rb`st_1 within s_w_multi_popup_rb
end type

type tab_action from s_w_multi_rb`tab_action within s_w_multi_popup_rb
end type

type gb_filter from s_w_multi_rb`gb_filter within s_w_multi_popup_rb
end type

type dw_filter from s_w_multi_rb`dw_filter within s_w_multi_popup_rb
end type

type dw_2 from s_w_multi_rb`dw_2 within s_w_multi_popup_rb
end type

type tab_1 from s_w_multi_rb`tab_1 within s_w_multi_popup_rb
end type

type dw_4 from s_w_multi_rb`dw_4 within s_w_multi_popup_rb
end type

type tv_1 from s_w_multi_rb`tv_1 within s_w_multi_popup_rb
end type

type dw_5 from s_w_multi_rb`dw_5 within s_w_multi_popup_rb
end type

type dw_6 from s_w_multi_rb`dw_6 within s_w_multi_popup_rb
end type

type ddlb_1 from s_w_multi_rb`ddlb_1 within s_w_multi_popup_rb
integer taborder = 250
end type

type ddlb_2 from s_w_multi_rb`ddlb_2 within s_w_multi_popup_rb
integer taborder = 400
end type

type cbx_1 from s_w_multi_rb`cbx_1 within s_w_multi_popup_rb
end type

type htb_1 from s_w_multi_rb`htb_1 within s_w_multi_popup_rb
end type

type cbx_2 from s_w_multi_rb`cbx_2 within s_w_multi_popup_rb
end type

type sle_1 from s_w_multi_rb`sle_1 within s_w_multi_popup_rb
integer taborder = 460
end type

type st_2 from s_w_multi_rb`st_2 within s_w_multi_popup_rb
end type

type gb_2 from s_w_multi_rb`gb_2 within s_w_multi_popup_rb
end type

type gb_1 from s_w_multi_rb`gb_1 within s_w_multi_popup_rb
end type

type gb_3 from s_w_multi_rb`gb_3 within s_w_multi_popup_rb
end type

type gb_4 from s_w_multi_rb`gb_4 within s_w_multi_popup_rb
end type

type gb_5 from s_w_multi_rb`gb_5 within s_w_multi_popup_rb
end type

type gb_6 from s_w_multi_rb`gb_6 within s_w_multi_popup_rb
end type

type gb_8 from s_w_multi_rb`gb_8 within s_w_multi_popup_rb
end type

type gb_9 from s_w_multi_rb`gb_9 within s_w_multi_popup_rb
end type

type gb_10 from s_w_multi_rb`gb_10 within s_w_multi_popup_rb
integer taborder = 170
end type

type gb_11 from s_w_multi_rb`gb_11 within s_w_multi_popup_rb
integer taborder = 330
end type

type gb_12 from s_w_multi_rb`gb_12 within s_w_multi_popup_rb
integer taborder = 110
end type

type dw_1 from s_w_multi_rb`dw_1 within s_w_multi_popup_rb
end type

type gb_7 from s_w_multi_rb`gb_7 within s_w_multi_popup_rb
end type

type dw_3 from s_w_multi_rb`dw_3 within s_w_multi_popup_rb
end type

type rb_1 from s_w_multi_rb`rb_1 within s_w_multi_popup_rb
end type

type rb_2 from s_w_multi_rb`rb_2 within s_w_multi_popup_rb
end type

type rb_3 from s_w_multi_rb`rb_3 within s_w_multi_popup_rb
end type
