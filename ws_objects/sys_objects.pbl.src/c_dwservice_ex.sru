$PBExportHeader$c_dwservice_ex.sru
$PBExportComments$cac function liên quan đến format, kiểm tra data
forward
global type c_dwservice_ex from s_object
end type
end forward

global type c_dwservice_ex from s_object
end type
global c_dwservice_ex c_dwservice_ex
...
public function integer f_get_build_column (powerobject vpo_dw, ref string rs_build_colname, ref string rs_coltype);c_string_ex	lc_string
...
on c_dwservice_ex.create
call super::create
end on

on c_dwservice_ex.destroy
call super::destroy
end on
