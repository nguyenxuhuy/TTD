...
public function string build (t_ds_db vds_source)
public function long findpairindex (string as_name)
end prototypes
...
public function string build (t_ds_db vds_source);json_pair pairsnull[]
pairs = pairsnull
integer li_level = 0
...
public function long findpairindex (string as_name);long p1, p2, index
