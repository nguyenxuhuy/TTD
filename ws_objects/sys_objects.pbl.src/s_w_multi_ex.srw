$PBExportHeader$s_w_multi_ex.srw
forward
global type s_w_multi_ex from s_w_main
end type
type dw_2 from t_dw_mpl within s_w_multi_ex
end type
type tab_1 from t_t within s_w_multi_ex
end type
type tab_1 from t_t within s_w_multi_ex
end type
type dw_4 from t_dw_mpl within s_w_multi_ex
end type
type tv_1 from t_tv within s_w_multi_ex
end type
type dw_5 from t_dw_mpl within s_w_multi_ex
end type
type dw_6 from t_dw_mpl within s_w_multi_ex
end type
type ddlb_1 from t_ddlb within s_w_multi_ex
end type
type ddlb_2 from t_ddlb within s_w_multi_ex
end type
type cbx_1 from t_cbx within s_w_multi_ex
end type
type htb_1 from t_htb within s_w_multi_ex
end type
type cbx_2 from t_cbx within s_w_multi_ex
end type
type sle_1 from t_sle within s_w_multi_ex
end type
type st_2 from t_st within s_w_multi_ex
end type
type gb_2 from t_g_line within s_w_multi_ex
end type
type gb_1 from t_g_line within s_w_multi_ex
end type
type gb_3 from t_g_line within s_w_multi_ex
end type
type gb_4 from t_g_line within s_w_multi_ex
end type
type gb_5 from t_g_line within s_w_multi_ex
end type
type gb_6 from t_gb within s_w_multi_ex
end type
type gb_8 from t_gb within s_w_multi_ex
end type
type gb_9 from t_gb within s_w_multi_ex
end type
type gb_10 from t_g_line within s_w_multi_ex
end type
type gb_11 from t_g_line within s_w_multi_ex
end type
type gb_12 from t_gb within s_w_multi_ex
end type
type dw_1 from t_dw_mpl within s_w_multi_ex
end type
type gb_7 from t_gb within s_w_multi_ex
end type
type dw_3 from t_dw_mpl within s_w_multi_ex
end type
type czkem_1 from olecustomcontrol within s_w_multi_ex
end type
type czkem_2 from olecustomcontrol within s_w_multi_ex
end type
type czkem_3 from olecustomcontrol within s_w_multi_ex
end type
type czkem_4 from olecustomcontrol within s_w_multi_ex
end type
type czkem_5 from olecustomcontrol within s_w_multi_ex
end type
type czkem_6 from olecustomcontrol within s_w_multi_ex
end type
type czkem_7 from olecustomcontrol within s_w_multi_ex
end type
type czkem_8 from olecustomcontrol within s_w_multi_ex
end type
type czkem_9 from olecustomcontrol within s_w_multi_ex
end type
type czkem_10 from olecustomcontrol within s_w_multi_ex
end type
type czkem_11 from olecustomcontrol within s_w_multi_ex
end type
type czkem_12 from olecustomcontrol within s_w_multi_ex
end type
type czkem_13 from olecustomcontrol within s_w_multi_ex
end type
type czkem_14 from olecustomcontrol within s_w_multi_ex
end type
type czkem_15 from olecustomcontrol within s_w_multi_ex
end type
type czkem_16 from olecustomcontrol within s_w_multi_ex
end type
type czkem_17 from olecustomcontrol within s_w_multi_ex
end type
type czkem_18 from olecustomcontrol within s_w_multi_ex
end type
type czkem_19 from olecustomcontrol within s_w_multi_ex
end type
type czkem_20 from olecustomcontrol within s_w_multi_ex
end type
type czkem_21 from olecustomcontrol within s_w_multi_ex
end type
type czkem_22 from olecustomcontrol within s_w_multi_ex
end type
type czkem_23 from olecustomcontrol within s_w_multi_ex
end type
type czkem_24 from olecustomcontrol within s_w_multi_ex
end type
type czkem_25 from olecustomcontrol within s_w_multi_ex
end type
type czkem_26 from olecustomcontrol within s_w_multi_ex
end type
type czkem_27 from olecustomcontrol within s_w_multi_ex
end type
type czkem_28 from olecustomcontrol within s_w_multi_ex
end type
type czkem_29 from olecustomcontrol within s_w_multi_ex
end type
type czkem_30 from olecustomcontrol within s_w_multi_ex
end type
type czkem_31 from olecustomcontrol within s_w_multi_ex
end type
type czkem_32 from olecustomcontrol within s_w_multi_ex
end type
type czkem_33 from olecustomcontrol within s_w_multi_ex
end type
type czkem_34 from olecustomcontrol within s_w_multi_ex
end type
type czkem_35 from olecustomcontrol within s_w_multi_ex
end type
type rb_1 from t_rb within s_w_multi_ex
end type
type rb_2 from t_rb within s_w_multi_ex
end type
type rb_3 from t_rb within s_w_multi_ex
end type
type czkem from olecustomcontrol within s_w_multi_ex
end type
end forward
...
global s_w_multi_ex s_w_multi_ex
...
public function integer f_set_data_copied_new (t_ds_db vds_copied[], s_str_dwo_related vstr_dwo_related[], string ls_type_copy, string vs_obj_related, s_w_multi_ex vw_t_copy)
public function integer f_set_data_copied (t_ds_db vds_copied[], s_str_dwo_related vstr_dwo_related[], string ls_type_copy, string vs_obj_related, s_w_multi_ex vw_f_copy)
...
this.f_openchildwithparm( 's_w_multi_n_max_ex', lc_obj_detail)
//this.f_openchildwithparm('s_w_multi_n',ls_obj_name +';0')
end event
...
public function integer f_set_data_copied (t_ds_db vds_copied[], s_str_dwo_related vstr_dwo_related[], string ls_type_copy, string vs_obj_related, s_w_multi_ex vw_f_copy);int 				li_idx,li_idx1,li_idx3,li_idx5,ll_find,li_count_rlt_copy
long				ll_rtn
string				las_to_col[],las_from_col[],las_column_sum[],ls_obj_ref_id,ls_find,las_empty[],las_dr_cr_obj_column[]
string				las_obj_ref_id[],las_f_obj_column_chk[],las_t_obj_column_chk[], las_match_column[], las_match_f_column[]
double			ldb_t_doc_id
...
type dw_filter from s_w_main`dw_filter within s_w_multi_ex
integer x = 686
integer y = 1432
integer width = 498
integer taborder = 10
...
type st_1 from s_w_main`st_1 within s_w_multi_ex
integer x = 91
integer y = 1104
integer width = 590
boolean border = true
...
type tab_action from s_w_main`tab_action within s_w_multi_ex
integer x = 279
integer y = 0
integer height = 308
integer taborder = 0
...
type gb_filter from s_w_main`gb_filter within s_w_multi_ex
integer x = 133
integer y = 816
integer taborder = 0
end type
...
string binarykey = "s_w_multi_ex.win"
integer textsize = -10
integer weight = 400
