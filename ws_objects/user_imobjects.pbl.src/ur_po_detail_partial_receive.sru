$PBExportHeader$ur_po_detail_partial_receive.sru
forward
global type ur_po_detail_partial_receive from b_report
end type
end forward

global type ur_po_detail_partial_receive from b_report
end type
global ur_po_detail_partial_receive ur_po_detail_partial_receive
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_po_detail_partial_receive_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_po_detail_partial_receive_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách nhập kho 1 phần'
...
istr_dwo[2].s_dwo_default = 'dp_po_detail_partial_receive_form'
istr_dwo[2].s_dwo_form = 'dp_po_detail_partial_receive_form'
...
on ur_po_detail_partial_receive.create
call super::create
end on

on ur_po_detail_partial_receive.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo phiếu nhập kho 1 phần'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_po_detail_partial_receive_form'
