$PBExportHeader$ur_warehouse_balance_excel_wo_serial.sru
forward
global type ur_warehouse_balance_excel_wo_serial from b_report
end type
end forward

global type ur_warehouse_balance_excel_wo_serial from b_report
end type
global ur_warehouse_balance_excel_wo_serial ur_warehouse_balance_excel_wo_serial
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default =  'dr_warehouse_balance_excel_wo_serial_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_warehouse_balance_excel_wo_serial_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo xuất nhập tồn theo kho (excel - không số serial)'
...
public subroutine f_set_dwo_tabpage_replace ();iastr_dwo_tabpage[1].s_tp_name = 's_tp_multi'
iastr_dwo_tabpage[1].s_display_model = '1d'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default =  'dr_wh_balance_xls_wo_serial_br_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_wh_balance_xls_wo_serial_br_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_grid = ''
iastr_dwo_tabpage[1].str_dwo[1].b_master = false
iastr_dwo_tabpage[1].str_dwo[1].b_detail = false
iastr_dwo_tabpage[1].str_dwo[1].b_cascade_del = false
...
on ur_warehouse_balance_excel_wo_serial.create
call super::create
end on

on ur_warehouse_balance_excel_wo_serial.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo xuất nhập tồn theo kho (excel - không số serial)'
