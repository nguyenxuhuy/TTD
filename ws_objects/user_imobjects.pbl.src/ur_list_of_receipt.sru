$PBExportHeader$ur_list_of_receipt.sru
forward
global type ur_list_of_receipt from b_report
end type
end forward

global type ur_list_of_receipt from b_report
end type
global ur_list_of_receipt ur_list_of_receipt
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_list_of_receipt_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_list_of_receipt_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo chi tiết nhập kho'
...
istr_dwo[2].s_dwo_default = 'dp_list_of_receipt_form'
istr_dwo[2].s_dwo_form = 'dp_list_of_receipt_form'
...
istr_dwo_related[1].s_main_obj_dwo = 'dr_list_of_receipt_form'		//datawindow quan hệ main
...
istr_dwo_related[2].s_main_obj_dwo = 'dr_list_of_receipt_form'		//datawindow quan hệ main
...
on ur_list_of_receipt.create
call super::create
end on

on ur_list_of_receipt.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo chi tiết nhập kho'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_list_of_receipt_form'
istr_report.s_pro_name = 'pkg_list_of_receipt.pro_list_of_receipt'
