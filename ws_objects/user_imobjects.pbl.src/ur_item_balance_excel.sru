$PBExportHeader$ur_item_balance_excel.sru
forward
global type ur_item_balance_excel from b_report
end type
end forward

global type ur_item_balance_excel from b_report
end type
global ur_item_balance_excel ur_item_balance_excel
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default =  'dr_item_balance_excel_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_item_balance_excel_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo xuất nhập tồn theo mã hàng (excel)'
...
istr_dwo[2].s_dwo_default =  'dp_item_balance_form'
istr_dwo[2].s_dwo_form = 'dp_item_balance_form'
...
on ur_item_balance_excel.create
call super::create
end on

on ur_item_balance_excel.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo xuất nhập tồn theo nhóm hàng (excel)'
