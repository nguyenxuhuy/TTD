$PBExportHeader$ur_so_detail_partial_issue.sru
forward
global type ur_so_detail_partial_issue from b_report
end type
end forward

global type ur_so_detail_partial_issue from b_report
end type
global ur_so_detail_partial_issue ur_so_detail_partial_issue
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_so_detail_partial_issue_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_so_detail_partial_issue_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách đơn hàng xuất kho 1 phần'
...
istr_dwo[2].s_dwo_default = 'dp_so_detail_partial_issue_form'
istr_dwo[2].s_dwo_form = 'dp_so_detail_partial_issue_form'
...
on ur_so_detail_partial_issue.create
call super::create
end on

on ur_so_detail_partial_issue.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo phiếu xuất kho 1 phần'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_so_detail_partial_issue_form'
