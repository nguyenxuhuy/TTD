$PBExportHeader$ur_goods_delivery_detail.sru
forward
global type ur_goods_delivery_detail from b_report
end type
end forward

global type ur_goods_delivery_detail from b_report
end type
global ur_goods_delivery_detail ur_goods_delivery_detail
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_goods_delivery_detail_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_goods_delivery_detail_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách phiếu xuất kho'
...
istr_dwo[2].s_dwo_default = 'dp_goods_delivery_detail_form'
istr_dwo[2].s_dwo_form = 'dp_goods_delivery_detail_form'
...
istr_dwo_related[1].s_main_obj_dwo = 'dr_goods_delivery_detail_form'		//datawindow quan hệ main
...
istr_dwo_related[2].s_main_obj_dwo = 'dr_goods_delivery_detail_form'		//datawindow quan hệ main
...
istr_dwo_related[3].s_main_obj_dwo = 'dr_goods_delivery_detail_form'		//datawindow quan hệ main
...
on ur_goods_delivery_detail.create
call super::create
end on

on ur_goods_delivery_detail.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo danh sách phiếu xuất kho'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_goods_delivery_detail_form'
