$PBExportHeader$ur_storecard.sru
forward
global type ur_storecard from b_report
end type
end forward

global type ur_storecard from b_report
end type
global ur_storecard ur_storecard
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_storecard_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_storecard_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo thẻ kho'
...
istr_dwo[2].s_dwo_default = 'dp_storecard_form'
istr_dwo[2].s_dwo_form = 'dp_storecard_form'
...
on ur_storecard.create
call super::create
end on

on ur_storecard.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo thẻ kho'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_storecard_form'
istr_report.s_pro_name = 'pkg_storecard.pro_insert_item_storecard'
...
ldw_parm= this.iw_display.f_get_dw( 'dp_storecard_form')
