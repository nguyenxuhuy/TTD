$PBExportHeader$ur_goods_receipt_detail.sru
forward
global type ur_goods_receipt_detail from b_report
end type
end forward

global type ur_goods_receipt_detail from b_report
end type
global ur_goods_receipt_detail ur_goods_receipt_detail
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_goods_receipt_detail_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_goods_receipt_detail_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách phiếu nhập kho'
...
istr_dwo[2].s_dwo_default = 'dp_goods_receipt_detail_form'
istr_dwo[2].s_dwo_form = 'dp_goods_receipt_detail_form'
...
public subroutine f_set_dwo_related ();istr_dwo_related[1].s_related_obj_name = 'u_goods_receipt'					// đối tượng liên quan
istr_dwo_related[1].s_main_obj_dwo = 'dr_goods_receipt_detail_form'		//datawindow quan hệ main
...
istr_dwo_related[1].s_text = 'Phiếu nhập kho'


istr_dwo_related[2].s_related_obj_name = 'u_pur_invoice'					// đối tượng liên quan
istr_dwo_related[2].s_main_obj_dwo = 'dr_goods_receipt_detail_form'		//datawindow quan hệ main
istr_dwo_related[2].s_main_obj_column = 'delivery_code'			// cột quan hệ của main
...
istr_dwo_related[2].s_text = 'Hoá đơn mua'


istr_dwo_related[3].s_related_obj_name = 'u_counting'					// đối tượng liên quan
istr_dwo_related[3].s_main_obj_dwo = 'dr_goods_receipt_detail_form'		//datawindow quan hệ main
istr_dwo_related[3].s_main_obj_column = 'delivery_code'			// cột quan hệ của main
...
on ur_goods_receipt_detail.create
call super::create
end on

on ur_goods_receipt_detail.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo danh sách phiếu nhập kho'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_goods_receipt_detail_form'
