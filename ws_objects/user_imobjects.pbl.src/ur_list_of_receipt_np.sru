$PBExportHeader$ur_list_of_receipt_np.sru
forward
global type ur_list_of_receipt_np from b_report
end type
end forward

global type ur_list_of_receipt_np from b_report
end type
global ur_list_of_receipt_np ur_list_of_receipt_np
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_list_of_receipt_np_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_list_of_receipt_np_form'
...
on ur_list_of_receipt_np.create
call super::create
end on

on ur_list_of_receipt_np.destroy
call super::destroy
end on
...
istr_report.s_dwo_report = 'dr_list_of_receipt_np_form'
