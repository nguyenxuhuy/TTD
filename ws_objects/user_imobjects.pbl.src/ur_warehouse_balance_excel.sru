$PBExportHeader$ur_warehouse_balance_excel.sru
forward
global type ur_warehouse_balance_excel from b_report
end type
end forward

global type ur_warehouse_balance_excel from b_report
end type
global ur_warehouse_balance_excel ur_warehouse_balance_excel
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default =  'dr_warehouse_balance_excel_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_warehouse_balance_excel_form'
...
on ur_warehouse_balance_excel.create
call super::create
end on

on ur_warehouse_balance_excel.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo xuất nhập tồn theo kho (excel)'
