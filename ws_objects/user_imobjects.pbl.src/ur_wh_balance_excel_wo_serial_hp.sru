$PBExportHeader$ur_wh_balance_excel_wo_serial_hp.sru
forward
global type ur_wh_balance_excel_wo_serial_hp from b_report
end type
end forward

global type ur_wh_balance_excel_wo_serial_hp from b_report
end type
global ur_wh_balance_excel_wo_serial_hp ur_wh_balance_excel_wo_serial_hp
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default =  'dr_wh_balance_excel_wo_serial_hp_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_wh_balance_excel_wo_serial_hp_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo xuất nhập tồn theo kho (excel - không số serial - Đại lý)'
...
on ur_wh_balance_excel_wo_serial_hp.create
call super::create
end on

on ur_wh_balance_excel_wo_serial_hp.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo xuất nhập tồn theo kho (excel - không số serial - đại lý)'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_item_balance_form'
istr_report.s_pro_name = 'pkg_item_balance.pro_insert_item_cus'
