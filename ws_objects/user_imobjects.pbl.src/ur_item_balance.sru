$PBExportHeader$ur_item_balance.sru
forward
global type ur_item_balance from b_report
end type
end forward

global type ur_item_balance from b_report
end type
global ur_item_balance ur_item_balance
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default =  'dr_item_balance_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_item_balance_form'
...
on ur_item_balance.create
call super::create
end on

on ur_item_balance.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo xuất nhập tồn theo nhóm hàng'
