$PBExportHeader$ur_cash_book.sru
forward
global type ur_cash_book from b_report
end type
end forward

global type ur_cash_book from b_report
end type
global ur_cash_book ur_cash_book
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_cash_book_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_cash_book_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Sổ quỹ tiền mặt'
...
istr_dwo[2].s_dwo_default = 'dp_cash_book_form'
istr_dwo[2].s_dwo_form = 'dp_cash_book_form'
...
istr_dwo_related[1].s_main_obj_dwo = 'dr_cash_book_form'		//datawindow quan hệ main
...
istr_dwo_related[2].s_main_obj_dwo = 'dr_cash_book_form'		//datawindow quan hệ main
...
istr_dwo_related[3].s_main_obj_dwo = 'dr_cash_book_form'		//datawindow quan hệ main
...
on ur_cash_book.create
call super::create
end on

on ur_cash_book.destroy
call super::destroy
end on

event constructor;call super::constructor;is_table = 'CASH_BOOK_TEMP'
ib_changed_dwo_4edit = false
is_display_model = '1ddlb_2d_1tp'
ib_display_text = true
is_object_title = 'Sổ quỹ tiền mặt'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_cash_book_form'
istr_report.s_pro_name = 'pkg_cash_book.pro_insert_cash_book'
...
ldw_parm= this.iw_display.f_get_dw( 'dp_cash_book_form')
