$PBExportHeader$ur_asset_depreciation_total.sru
forward
global type ur_asset_depreciation_total from b_report
end type
end forward

global type ur_asset_depreciation_total from b_report
end type
global ur_asset_depreciation_total ur_asset_depreciation_total
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_asset_depreciation_total_form' 
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_asset_depreciation_total_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Khấu hao TSCĐ'
...
istr_dwo[2].s_dwo_default = 'dp_asset_depreciation_form'
istr_dwo[2].s_dwo_form = 'dp_asset_depreciation_form'
...
on ur_asset_depreciation_total.create
call super::create
end on

on ur_asset_depreciation_total.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo khấu hao TSCĐ'
istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_asset_depreciation_total_form'
istr_report.s_pro_name = 'PKG_ASSET.PRO_INSERT_TMP_ASET_REPORT'
