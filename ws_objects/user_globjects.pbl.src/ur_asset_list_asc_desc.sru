$PBExportHeader$ur_asset_list_asc_desc.sru
forward
global type ur_asset_list_asc_desc from b_report
end type
end forward

global type ur_asset_list_asc_desc from b_report
end type
global ur_asset_list_asc_desc ur_asset_list_asc_desc
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_asset_list_asc_desc_form' 
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_asset_list_asc_desc_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Tăng giảm TSCĐ'
...
istr_dwo[2].s_dwo_default = 'dp_asset_list_asc_desc_form'
istr_dwo[2].s_dwo_form = 'dp_asset_list_asc_desc_form'
...
on ur_asset_list_asc_desc.create
call super::create
end on

on ur_asset_list_asc_desc.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo tình hình tăng giảm TSCĐ'
istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_asset_list_asc_desc_form'
istr_report.s_pro_name = 'PKG_ASSET_LIST_ASC_DESC.PRO_INS_ASSET_LIST_ASC_DESC'
