$PBExportHeader$ur_income_statement.sru
forward
global type ur_income_statement from b_report
end type
end forward

global type ur_income_statement from b_report
end type
global ur_income_statement ur_income_statement
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_income_statement_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_income_statement_form'
...
istr_dwo[2].s_dwo_default = 'dp_income_statement_form'
istr_dwo[2].s_dwo_form = 'dp_income_statement_form'
...
on ur_income_statement.create
call super::create
end on

on ur_income_statement.destroy
call super::destroy
end on
...
istr_report.s_dwo_report = 'dr_income_statement_form'
istr_report.s_pro_name = 'pkg_income_statement.pro_income_statement'
...
ldw_parm= this.iw_display.f_get_dw( 'dp_income_statement_form')
