$PBExportHeader$ur_gl_checking.sru
forward
global type ur_gl_checking from b_report
end type
end forward

global type ur_gl_checking from b_report
end type
global ur_gl_checking ur_gl_checking
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_gl_checking_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_gl_checking_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Kiểm tra chứng từ'
...
istr_dwo[2].s_dwo_default = 'dp_gl_checking_form'
istr_dwo[2].s_dwo_form = 'dp_gl_checking_form'
...
on ur_gl_checking.create
call super::create
end on

on ur_gl_checking.destroy
call super::destroy
end on

event constructor;call super::constructor;is_table = 'V_GL_CHECKING'
ib_changed_dwo_4edit = false
is_display_model = '1ddlb_2d_1tp'
ib_display_text = true
is_object_title = 'Kiểm tra các chứng từ'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_gl_checking_form'
