$PBExportHeader$ur_input_tax_list.sru
forward
global type ur_input_tax_list from b_report
end type
end forward

global type ur_input_tax_list from b_report
end type
global ur_input_tax_list ur_input_tax_list
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_input_tax_list_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_input_tax_list_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Bảng kê đầu vào thuế GTGT'
...
istr_dwo[2].s_dwo_default = 'dp_input_tax_list_form'
istr_dwo[2].s_dwo_form = 'dp_input_tax_list_form'
...
on ur_input_tax_list.create
call super::create
end on

on ur_input_tax_list.destroy
call super::destroy
end on

event constructor;call super::constructor;is_table = 'TAX_LINE'
ib_changed_dwo_4edit = false
is_display_model = '1ddlb_2d_1tp'
ib_display_text = true
is_object_title = 'Bảng kê đầu vào thuế GTGT'
