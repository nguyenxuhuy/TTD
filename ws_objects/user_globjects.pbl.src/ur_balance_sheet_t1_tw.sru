$PBExportHeader$ur_balance_sheet_t1_tw.sru
forward
global type ur_balance_sheet_t1_tw from b_report
end type
end forward

global type ur_balance_sheet_t1_tw from b_report
end type
global ur_balance_sheet_t1_tw ur_balance_sheet_t1_tw
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_balance_sheet_t1_tw_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_balance_sheet_t1_tw_form'
...
istr_dwo[2].s_dwo_default = 'dp_balance_sheet_t1_tw_form'
istr_dwo[2].s_dwo_form = 'dp_balance_sheet_t1_tw_form'
...
on ur_balance_sheet_t1_tw.create
call super::create
end on

on ur_balance_sheet_t1_tw.destroy
call super::destroy
end on

event constructor;call super::constructor;is_table = 'BALANCE_SHEET_T_TW_TMP'
...
istr_report.s_dwo_report = 'dr_balance_sheet_t1_tw_form'
istr_report.s_pro_name = 'pkg_balance_sheet_t1_tw.pro_balance_sheet'
istr_report.sa_parm_name[1] = 'p_period_date_1'
istr_report.sa_parm_name[2] = 'gs_sob'
