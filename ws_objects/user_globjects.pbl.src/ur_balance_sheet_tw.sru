$PBExportHeader$ur_balance_sheet_tw.sru
forward
global type ur_balance_sheet_tw from b_report
end type
end forward

global type ur_balance_sheet_tw from b_report
end type
global ur_balance_sheet_tw ur_balance_sheet_tw
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_balance_sheet_tw_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_balance_sheet_tw_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Bảng cân đối kế toán'
...
istr_dwo[2].s_dwo_default = 'dp_balance_sheet_tw_form'
istr_dwo[2].s_dwo_form = 'dp_balance_sheet_tw_form'
...
on ur_balance_sheet_tw.create
call super::create
end on

on ur_balance_sheet_tw.destroy
call super::destroy
end on
...
is_object_title = 'Bảng cân đối kế toán'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_balance_sheet_tw_form'
istr_report.s_pro_name = 'pkg_balance_sheet_tw.pro_balance_sheet'
istr_report.sa_parm_name[1] = 'p_period_date_1'
istr_report.sa_parm_name[2] = 'p_period_date_2'
istr_report.sa_parm_name[3] = 'p_period_date_3'
istr_report.sa_parm_name[4] = 'p_period_date_4'
istr_report.sa_parm_name[5] = 'p_period_date_5'
istr_report.sa_parm_name[6] = 'p_period_date_6'
