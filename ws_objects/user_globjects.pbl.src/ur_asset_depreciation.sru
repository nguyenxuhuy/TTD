$PBExportHeader$ur_asset_depreciation.sru
forward
global type ur_asset_depreciation from b_report
end type
end forward

global type ur_asset_depreciation from b_report
end type
global ur_asset_depreciation ur_asset_depreciation
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_asset_depreciation_form' 
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_asset_depreciation_form'
...
on ur_asset_depreciation.create
call super::create
end on

on ur_asset_depreciation.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo chi tiết khấu hao TSCĐ'
istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_asset_depreciation_form'
