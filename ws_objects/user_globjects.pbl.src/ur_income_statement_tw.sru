$PBExportHeader$ur_income_statement_tw.sru
forward
global type ur_income_statement_tw from b_report
end type
end forward

global type ur_income_statement_tw from b_report
end type
global ur_income_statement_tw ur_income_statement_tw
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_income_statement_tw_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_income_statement_tw_form'
...
istr_dwo[2].s_dwo_default = 'dp_income_statement_tw_form'
istr_dwo[2].s_dwo_form = 'dp_income_statement_tw_form'
...
on ur_income_statement_tw.create
call super::create
end on

on ur_income_statement_tw.destroy
call super::destroy
end on
...
istr_report.s_dwo_report = 'dr_income_statement_tw_form'
istr_report.s_pro_name = 'pkg_income_statement_tw.pro_income_statement'
...
istr_report.sa_parm_name[9] = 'p_f_date_5'
istr_report.sa_parm_name[10] = 'p_t_date_5'
istr_report.sa_parm_name[11] = 'p_f_date_6'
istr_report.sa_parm_name[12] = 'p_t_date_6'
istr_report.sa_parm_name[13] = 'gs_sob'
istr_report.sa_parm_name[14] = 'gi_user_id'
istr_report.sa_parm_value[14] = gi_userid
