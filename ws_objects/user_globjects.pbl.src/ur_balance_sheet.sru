$PBExportHeader$ur_balance_sheet.sru
forward
global type ur_balance_sheet from b_report
end type
end forward

global type ur_balance_sheet from b_report
end type
global ur_balance_sheet ur_balance_sheet
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_balance_sheet_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_balance_sheet_form'
...
istr_dwo[2].s_dwo_default = 'dp_balance_sheet_form'
istr_dwo[2].s_dwo_form = 'dp_balance_sheet_form'
...
on ur_balance_sheet.create
call super::create
end on

on ur_balance_sheet.destroy
call super::destroy
end on
...
istr_report.s_dwo_report = 'dr_balance_sheet_form'
istr_report.s_pro_name = 'pkg_balance_sheet.pro_balance_sheet'
istr_report.sa_parm_name[1] = 'p_prior_period_date'
istr_report.sa_parm_name[2] = 'p_this_period_date'
...
ldw_parm= this.iw_display.f_get_dw( 'dp_balance_sheet_form')
