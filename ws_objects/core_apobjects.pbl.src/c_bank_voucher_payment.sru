$PBExportHeader$c_bank_voucher_payment.sru
forward
global type c_bank_voucher_payment from b_doc
end type
end forward

global type c_bank_voucher_payment from b_doc
end type
global c_bank_voucher_payment c_bank_voucher_payment
...
on c_bank_voucher_payment.create
call super::create
end on

on c_bank_voucher_payment.destroy
call super::destroy
end on
...
rpo_dw.setitem(vl_currentrow,'doc_type','BANK_VOUCHER_PAYMENT')
...
laa_value[1] = '=BANK_VOUCHER_PAYMENT'
