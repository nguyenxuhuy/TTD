$PBExportHeader$c_driver_retrieve.sru
forward
global type c_driver_retrieve from b_doc
end type
end forward

global type c_driver_retrieve from b_doc
end type
global c_driver_retrieve c_driver_retrieve
...
public subroutine f_set_dwo_window ();istr_dwo[1].s_dwo_default =  'd_driver_retrieve_grid'
istr_dwo[1].s_dwo_form = ''
istr_dwo[1].s_dwo_grid = 'd_driver_retrieve_grid'
...
istr_dwo[1].s_description = 'Cước xe tài xế'
...
on c_driver_retrieve.create
call super::create
end on

on c_driver_retrieve.destroy
call super::destroy
end on
...
//else
	is_object_title = 'Xem cước phí tài xế'
//end if
is_exrate_type = 'sell'
			...
			if istr_actionpane[li_idx].s_dwo_action = 'd_action_edit' then
				...
				if ldw_focus.dynamic f_get_ib_detail() then
					...
					if  ib_changed_dwo_4edit then
						...
						istr_actionpane[li_idx].s_visible_buttons='b_filteron;b_refresh;'
					end if
				end if
