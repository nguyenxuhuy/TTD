$PBExportHeader$c_doc_headfooter.sru
forward
global type c_doc_headfooter from s_object_display
end type
end forward

global type c_doc_headfooter from s_object_display
end type
global c_doc_headfooter c_doc_headfooter
...
public subroutine f_set_dwo_window ();istr_dwo[1].s_dwo_default =  'd_doc_headfooter_grid'
istr_dwo[1].s_dwo_form = ''
istr_dwo[1].s_dwo_grid = 'd_doc_headfooter_grid'
...
istr_dwo[1].s_description = 'Khai báo Footer của chứng từ'
end subroutine
...
on c_doc_headfooter.create
call super::create
end on

on c_doc_headfooter.destroy
call super::destroy
end on
...
is_object_title = 'Khai báo Footer của chứng từ'
