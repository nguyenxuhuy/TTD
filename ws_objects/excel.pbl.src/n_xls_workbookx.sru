$PBExportHeader$n_xls_workbookx.sru
forward
global type n_xls_workbookx from nonvisualobject
end type
end forward
...
global n_xls_workbookx n_xls_workbookx
...
public n_xls_worksheetx invo_worksheets[]
public n_xls_formatx invo_formats[]
...
public n_xls_formatx invo_tmp_format
public n_xls_formatx invo_url_format
public n_xls_datax invo_data
...
public function n_xls_formatx of_add_format ()
public function long of_get_xf (ref n_xls_formatx anvo_format)
public function n_xls_worksheetx of_add_worksheet ()
public function n_xls_worksheetx of_add_worksheet (blob ab_worksheetname)
public function n_xls_worksheetx of_add_worksheet (string as_worksheetname)
...
public function n_xls_formatx of_add_format (string as_fontname, integer ai_fontsize, string as_align, boolean ab_bold, string as_border)
public function long of_reg_format (ref n_xls_formatx anvo_format, boolean ab_new)
...
public function n_xls_formatx of_add_format ();n_xls_formatx lnvo_format

lnvo_format = create n_xls_formatx
return lnvo_format
end function

public function long of_get_xf (ref n_xls_formatx anvo_format);string ls_key
long li_ret
...
public function n_xls_worksheetx of_add_worksheet ();return of_add_worksheet("")
end function

public function n_xls_worksheetx of_add_worksheet (blob ab_worksheetname);integer li_ret = 1
integer li_i
integer li_len
string ls_name
n_xls_worksheetx lnvo_cursheet
n_xls_worksheetx lnvo_worksheet
...
do
	...
	lnvo_worksheet = create n_xls_worksheetx
...
public function n_xls_worksheetx of_add_worksheet (string as_worksheetname);return of_add_worksheet(invo_sub.of_ansi2unicode(as_worksheetname))
end function
...
invo_tmp_format = create n_xls_formatx
...
public function n_xls_formatx of_add_format (string as_fontname, integer ai_fontsize, string as_align, boolean ab_bold, string as_border);char lc_borders[]
...
public function long of_reg_format (ref n_xls_formatx anvo_format, boolean ab_new);string ls_key
long li_ret
blob lb_key
...
if anvo_format.ii_xf_index > 0 then
	...
	if isnull(li_ret) or li_ret = 0 then
		...
		il_formatindex ++
		if ab_new then
			invo_formats[il_formatindex] = create n_xls_formatx
...
on n_xls_workbookx.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_xls_workbookx.destroy
