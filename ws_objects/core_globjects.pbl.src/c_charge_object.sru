$PBExportHeader$c_charge_object.sru
forward
global type c_charge_object from s_object_display
end type
end forward
...
global c_charge_object c_charge_object
...
istr_dwo[1].s_dwo_details = 'd_charge_object_form;'
...
istr_dwo[1].s_description = 'Khoản phí'
...
istr_dwo[2].s_description = 'Khoản phí'
istr_dwo[2].s_pic_ref_table = ''
istr_dwo[2].s_pic_ref_field = ''

istr_dwo[3].s_dwo_default =  'd_charge_object_form'
istr_dwo[3].s_dwo_form = 'd_charge_object_form'
istr_dwo[3].s_dwo_grid = ''
istr_dwo[3].b_detail = true
istr_dwo[3].b_master = true
istr_dwo[3].s_dwo_master = 'd_objects_grid;'
istr_dwo[3].s_dwo_details = 'd_organization_form;d_representative_form;d_address_grid;'
...
istr_dwo[3].s_description = 'Thộng tin chi tiết phí'

istr_dwo[4].s_dwo_default =  'd_organization_form'
istr_dwo[4].s_dwo_form = 'd_organization_form'
...
istr_dwo[4].s_description = 'Thông tin khoản phí'
istr_dwo[4].s_pic_ref_table='LEGAL_ENTITY'
...
on c_charge_object.create
call super::create
end on

on c_charge_object.destroy
call super::destroy
end on
...
if pos(rpo_dw.dataobject, 'd_objects_')> 0 then
	...
	ldw_handle = iw_display.dynamic f_get_dw('d_charge_object_form')
	ldw_handle.event e_addrow( )
	ldw_handle = iw_display.dynamic f_get_dw('d_organization_form')
	ldw_handle.event e_addrow( )	
