$PBExportHeader$cl_receipt_all.sru
forward
global type cl_receipt_all from c_receipt
end type
end forward

global type cl_receipt_all from c_receipt
end type
global cl_receipt_all cl_receipt_all
...
on cl_receipt_all.create
call super::create
end on

on cl_receipt_all.destroy
call super::destroy
end on
