$PBExportHeader$u_detail_payment.sru
forward
global type u_detail_payment from b_detail
end type
end forward
...
global u_detail_payment u_detail_payment
...
on u_detail_payment.create
call super::create
end on

on u_detail_payment.destroy
call super::destroy
end on
