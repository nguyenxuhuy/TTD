$PBExportHeader$ur_pur_invoice_detail.sru
forward
global type ur_pur_invoice_detail from b_report
end type
end forward

global type ur_pur_invoice_detail from b_report
end type
global ur_pur_invoice_detail ur_pur_invoice_detail
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_pur_invoice_detail_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_pur_invoice_detail_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách hóa đơn mua'
...
istr_dwo[2].s_dwo_default = 'dp_pur_invoice_detail_form'
istr_dwo[2].s_dwo_form = 'dp_pur_invoice_detail_form'
...
istr_dwo_related[1].s_main_obj_dwo = 'dr_pur_invoice_detail_form'		//datawindow quan hệ main
istr_dwo_related[1].s_main_obj_column = 'pur_code'			// cột quan hệ của main
...
istr_dwo_related[1].s_relatedtext_column = 'pur_code'					
...
on ur_pur_invoice_detail.create
call super::create
end on

on ur_pur_invoice_detail.destroy
call super::destroy
end on

event constructor;call super::constructor;is_table = 'V_PUR_INVOICE_DETAIL'
ib_changed_dwo_4edit = false
is_display_model = '1ddlb_2d_1tp'
ib_display_text = true
is_object_title = 'Báo cáo danh sách hóa đơn mua'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_pur_invoice_detail_form'
