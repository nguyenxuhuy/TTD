$PBExportHeader$u_detail_bank_cash_retreive.sru
forward
global type u_detail_bank_cash_retreive from b_detail
end type
end forward
...
global u_detail_bank_cash_retreive u_detail_bank_cash_retreive
...
on u_detail_bank_cash_retreive.create
call super::create
end on

on u_detail_bank_cash_retreive.destroy
call super::destroy
end on
