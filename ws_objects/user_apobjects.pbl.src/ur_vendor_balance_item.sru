$PBExportHeader$ur_vendor_balance_item.sru
forward
global type ur_vendor_balance_item from b_report
end type
end forward

global type ur_vendor_balance_item from b_report
end type
global ur_vendor_balance_item ur_vendor_balance_item
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_vendor_balance_item_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_vendor_balance_item_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo chi tiết công nợ nhà cung cấp theo mặt hàng'
...
istr_dwo[2].s_dwo_default = 'dp_vendor_balance_item_form'
istr_dwo[2].s_dwo_form = 'dp_vendor_balance_item_form'
...
istr_dwo_related[1].s_main_obj_dwo = 'dr_vendor_balance_item_form'		//datawindow quan hệ main
...
on ur_vendor_balance_item.create
call super::create
end on

on ur_vendor_balance_item.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo chi tiết công nợ nhà cung cấp theo mặt hàng'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_vendor_balance_item_form'
//istr_report.s_pro_name = 'pkg_vendor_balance_item.pro_vendor_bal_item'
...
ldw_parm= this.iw_display.f_get_dw( 'dp_vendor_balance_item_form')
