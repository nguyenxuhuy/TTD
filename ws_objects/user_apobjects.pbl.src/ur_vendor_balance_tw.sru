$PBExportHeader$ur_vendor_balance_tw.sru
forward
global type ur_vendor_balance_tw from b_report
end type
end forward

global type ur_vendor_balance_tw from b_report
end type
global ur_vendor_balance_tw ur_vendor_balance_tw
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_vendor_balance_tw_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_vendor_balance_tw_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo công nợ nhà cung cấp tw'
...
istr_dwo[2].s_dwo_default = 'dp_vendor_balance_tw_form'
istr_dwo[2].s_dwo_form = 'dp_vendor_balance_tw_form'
...
on ur_vendor_balance_tw.create
call super::create
end on

on ur_vendor_balance_tw.destroy
call super::destroy
end on
...
istr_report.s_dwo_report = 'dr_vendor_balance_tw_form'
istr_report.s_pro_name = 'pkg_vendor_balance_tw.pro_vendor_balance'
