$PBExportHeader$ur_staff_balance.sru
forward
global type ur_staff_balance from b_report
end type
end forward

global type ur_staff_balance from b_report
end type
global ur_staff_balance ur_staff_balance
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_staff_balance_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_staff_balance_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo tổng hợp tạm ứng nhân viên'
...
istr_dwo[2].s_dwo_default = 'dp_staff_balance_form'
istr_dwo[2].s_dwo_form = 'dp_staff_balance_form'
...
on ur_staff_balance.create
call super::create
end on

on ur_staff_balance.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo tổng hợp tạm ứng nhân viên'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_staff_balance_form'
istr_report.s_pro_name = 'pkg_staff_balance.pro_insert_staff_balance'
