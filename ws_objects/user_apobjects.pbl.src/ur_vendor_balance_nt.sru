$PBExportHeader$ur_vendor_balance_nt.sru
forward
global type ur_vendor_balance_nt from b_report
end type
end forward

global type ur_vendor_balance_nt from b_report
end type
global ur_vendor_balance_nt ur_vendor_balance_nt
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_vendor_balance_nt_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_vendor_balance_nt_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='In giấy báo công nợ nhà cung cấp'
...
istr_dwo[2].s_dwo_default = 'dp_vendor_balance_nt_form'
istr_dwo[2].s_dwo_form = 'dp_vendor_balance_nt_form'
...
on ur_vendor_balance_nt.create
call super::create
end on

on ur_vendor_balance_nt.destroy
call super::destroy
end on
...
is_object_title = 'In công  nợ nhà cung cấp'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_vendor_balance_nt_form'
istr_report.s_pro_name = 'pkg_vendor_balance_nt.pro_insert_vendor_bal_base'
