$PBExportHeader$ur_bank_voucher_payment_detail.sru
forward
global type ur_bank_voucher_payment_detail from b_report
end type
end forward

global type ur_bank_voucher_payment_detail from b_report
end type
global ur_bank_voucher_payment_detail ur_bank_voucher_payment_detail
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_bank_voucher_payment_detail_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_bank_voucher_payment_detail_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo danh sách phiếu sổ phụ NH chi'
...
istr_dwo[2].s_dwo_default = 'dp_bank_voucher_payment_detail_form'
istr_dwo[2].s_dwo_form = 'dp_bank_voucher_payment_detail_form'
...
istr_dwo_related[1].s_main_obj_dwo = 'dr_bank_voucher_payment_detail_form'		//datawindow quan hệ main
...
istr_dwo_related[1].s_relatedtext_column = 'delivery_code'					
...
on ur_bank_voucher_payment_detail.create
call super::create
end on

on ur_bank_voucher_payment_detail.destroy
call super::destroy
end on

event constructor;call super::constructor;is_table = 'v_bank_voucher_payment_detail'
ib_changed_dwo_4edit = false
is_display_model = '1ddlb_2d_1tp'
ib_display_text = true
is_object_title = 'Báo cáo danh sách phiếu sổ phụ NH chi'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_bank_voucher_payment_detail_form'
