$PBExportHeader$ur_vendor_aging_balance.sru
forward
global type ur_vendor_aging_balance from b_report
end type
end forward

global type ur_vendor_aging_balance from b_report
end type
global ur_vendor_aging_balance ur_vendor_aging_balance
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_vendor_aging_balance_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_vendor_aging_balance_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Báo cáo tuổi nợ nhà cung cấp'
...
istr_dwo[2].s_dwo_default = 'dp_vendor_aging_balance_form'
istr_dwo[2].s_dwo_form = 'dp_vendor_aging_balance_form'
...
on ur_vendor_aging_balance.create
call super::create
end on

on ur_vendor_aging_balance.destroy
call super::destroy
end on
...
is_object_title = 'Báo cáo tuổi nợ nhà cung cấp'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_vendor_aging_balance_form'
istr_report.s_pro_name = 'pkg_vendor_aging_balance.pro_insert_ven_aging_bal'
