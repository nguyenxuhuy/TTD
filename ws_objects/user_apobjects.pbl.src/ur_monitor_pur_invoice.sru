$PBExportHeader$ur_monitor_pur_invoice.sru
forward
global type ur_monitor_pur_invoice from b_report
end type
end forward

global type ur_monitor_pur_invoice from b_report
end type
global ur_monitor_pur_invoice ur_monitor_pur_invoice
...
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_default = 'dr_monitor_pur_invoice_form'
iastr_dwo_tabpage[1].str_dwo[1].s_dwo_form = 'dr_monitor_pur_invoice_form'
...
iastr_dwo_tabpage[1].str_dwo[1].s_description ='Bảng chi tiết công nợ phải trả'
...
istr_dwo[2].s_dwo_default = 'dp_monitor_pur_invoice_form'
istr_dwo[2].s_dwo_form = 'dp_monitor_pur_invoice_form'
...
on ur_monitor_pur_invoice.create
call super::create
end on

on ur_monitor_pur_invoice.destroy
call super::destroy
end on

event constructor;call super::constructor;is_table = 'MONITOR_PUR_INVOICE_TMP'
ib_changed_dwo_4edit = false
is_display_model = '1ddlb_2d_1tp'
ib_display_text = true
is_object_title = 'Bảng chi tiết công nợ phải trả'

istr_actionpane[1].s_description = is_object_title

istr_report.s_dwo_report = 'dr_monitor_pur_invoice_form'
istr_report.s_pro_name = 'pkg_monitor_pur_invoice.pro_monitor_pur_invoice'
