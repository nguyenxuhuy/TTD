$PBExportHeader$u_pur_invoice_total.sru
forward
global type u_pur_invoice_total from b_copy
end type
end forward

global type u_pur_invoice_total from b_copy
end type
global u_pur_invoice_total u_pur_invoice_total
...
istr_dwo[1].s_dwo_default =  'd_document_ap_total_grid'
istr_dwo[1].s_dwo_form = ''
istr_dwo[1].s_dwo_grid = 'd_document_ap_total_grid'
istr_dwo[1].b_master = true
istr_dwo[1].b_cascade_del = true
istr_dwo[1].s_dwo_details = 'd_invoice_pur_form;' 
...
public subroutine f_set_dwo_window_copy ();istr_dwo[1].s_dwo_default =  'd_document_ap_total_grid'
istr_dwo[1].s_dwo_form = ''
istr_dwo[1].s_dwo_grid = 'd_document_ap_total_grid'
istr_dwo[1].b_master = true
istr_dwo[1].b_cascade_del = true
...
istr_dwo[2].s_dwo_default =  'd_invoice_pur_form'
istr_dwo[2].s_dwo_form = 'd_invoice_pur_form'
istr_dwo[2].s_dwo_grid = ''
istr_dwo[2].b_master = true
istr_dwo[2].b_detail = true
istr_dwo[2].b_cascade_del = true
istr_dwo[2].s_dwo_details = 'd_pur_invoice_line_grid;'
istr_dwo[2].s_dwo_master = 'd_document_ap_total_grid;'
istr_dwo[2].s_dwo_shared = 'd_pur_tax_desc_form;'
...
istr_dwo[2].s_description = 'Hóa đơn'
...
istr_dwo[4].s_dwo_default =  'd_pur_invoice_line_grid'
istr_dwo[4].s_dwo_form = 'd_pur_invoice_line_form'
istr_dwo[4].s_dwo_grid = 'd_pur_invoice_line_grid'
istr_dwo[4].b_master = true
istr_dwo[4].b_detail = true
istr_dwo[4].b_cascade_del = true
istr_dwo[4].s_dwo_master = 'd_invoice_pur_form;'
...
istr_dwo[5].s_dwo_master = 'd_pur_invoice_line_grid;'
...
istr_dwo[5].s_description ='Định khoản hóa đơn'
...
istr_dwo[6].s_dwo_master = 'd_pur_invoice_line_grid;'
...
istr_dwo[8].s_dwo_master = 'd_pur_invoice_line_grid;'
...
istr_dwo_related[1].s_main_obj_dwo = 'd_document_ap_total_grid'		//datawindow quan hệ main
...
istr_dwo_related[1].s_text = 'Phiếu chi từ:'
...
istr_dwo_related[1].s_main_obj_column_copy[1] ='CR_OBJECT_ID;trans_amt;base_amt'  // cột copy từ
istr_dwo_related[1].s_related_obj_column_copy[1] = 'OBJECT_ID;amount;base_amount'  // cột copy đến
istr_dwo_related[1].s_main_dr_cr_obj_dwo_sum[1]='d_invoice_pur_form'
istr_dwo_related[1].s_main_dr_cr_obj_column_sum[1]='dr_cr_object'
istr_dwo_related[1].s_main_obj_column_sum[1] = 'trans_amt;base_amt'
istr_dwo_related[1].s_f_obj_column_chk[1] = 'CR_OBJECT_ID'
...
istr_dwo_related[1].s_main_obj_dwo_copy[2] = 'd_post_line_tax_grid'
istr_dwo_related[1].s_related_obj_dwo_copy[2] = 'd_payment_line_grid'
istr_dwo_related[1].s_main_obj_column_copy[2] ='CR_OBJECT_ID;trans_amt;base_amt'
istr_dwo_related[1].s_related_obj_column_copy[2] = 'OBJECT_ID;amount;base_amount'
istr_dwo_related[1].s_main_dr_cr_obj_dwo_sum[2]='d_invoice_pur_form'
istr_dwo_related[1].s_main_dr_cr_obj_column_sum[2]='dr_cr_object'
istr_dwo_related[1].s_main_obj_column_sum[2] = 'trans_amt;base_amt'
istr_dwo_related[1].s_f_obj_column_chk[2] = 'CR_OBJECT_ID'
...
istr_dwo_related[1].s_main_obj_dwo_copy[3] = 'd_invoice_pur_form' // datawindow copy từ
istr_dwo_related[1].s_main_obj_column_copy[3] ='dr_cr_object;dr_cr_object_type;dr_cr_object_code;dr_cr_object_name' // cột copy từ
istr_dwo_related[1].s_related_obj_dwo_copy[3] = 'd_payment_line_grid' // datawindow copy đến
istr_dwo_related[1].s_related_obj_column_copy[3] = 'object_id;object_type;object_code;object_name'  // cột copy đến
...
istr_dwo_related[1].s_match_f_dwo[3] = 'd_payment_line_grid'
istr_dwo_related[1].s_match_t_dwo[3] = 'd_charge_line_grid'
istr_dwo_related[1].s_match_f_column[3] = 'amount;base_amount;'
istr_dwo_related[1].s_match_t_column[3] = 'CHARGE_AMT;CHARGE_BASE_AMT;'
istr_dwo_related[1].s_match_column[3] = 'trans_value;base_value;'
//////////////////////////////////////////////////////////////////////////////
istr_dwo_related[1].s_main_obj_dwo_copy[4] = 'd_invoice_pur_form' // datawindow copy từ
istr_dwo_related[1].s_main_obj_column_copy[4] ='currency_id;uom_code;exchange_rate;dr_cr_object' // cột copy từ
istr_dwo_related[1].s_related_obj_dwo_copy[4] = 'd_payment_form' // datawindow copy đến
...
on u_pur_invoice_total.create
call super::create
end on

on u_pur_invoice_total.destroy
call super::destroy
end on
...
is_object_title = 'Hóa đơn mua tổng'
...
setnull(ls_null)
laa_data[1] = '(vendor; tax;misc_charge)'
