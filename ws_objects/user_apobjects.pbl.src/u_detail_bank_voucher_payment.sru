$PBExportHeader$u_detail_bank_voucher_payment.sru
forward
global type u_detail_bank_voucher_payment from b_detail
end type
end forward
...
global u_detail_bank_voucher_payment u_detail_bank_voucher_payment
...
on u_detail_bank_voucher_payment.create
call super::create
end on

on u_detail_bank_voucher_payment.destroy
call super::destroy
end on
