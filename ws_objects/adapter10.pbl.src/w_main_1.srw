$PBExportHeader$w_main_1.srw
forward
global type w_main_1 from window
end type
type cb_cancel from commandbutton within w_main_1
end type
type dw_adapters from datawindow within w_main_1
end type
end forward
